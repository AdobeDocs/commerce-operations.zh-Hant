...
description: 瞭解2.4.5-p3 Adobe Commerce版本中安全性問題的修正。
...
Adobe Commerce 2.4.5-p3是安全性版本，提供13項安全性修正，可增強您的Adobe Commerce 2.4.5或Magento Open Source2.4.5部署。 它針對先前版本中發現的弱點提供修正。
...
如需下載和套用安全性修補程式（包括修補程式2.4.5-p3）的說明，請參閱 [快速開始安裝](../../../installation/composer.md).
