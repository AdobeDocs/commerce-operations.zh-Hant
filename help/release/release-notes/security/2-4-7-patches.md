...
>
>在此日期之後，Adobe Commerce 2.4.7將不針對MySQL 8.0之後發行的任何MySQL版本提供相容性或>支援。Adobe將不會在此Adobe>Commerce發行版本中>驗證或支援較新的MySQL主要版本。
>
>強烈建議所有執行2.4.7版的Adobe Commerce內部部署客戶>將其資料庫伺服器移轉至相容的MariaDB版本。
