---
title: Adobe Commerce 2.4.6-p4發行說明
description: 瞭解關於2.4.6-p4 Adobe Commerce版本中安全性問題的修正。
...
# Adobe Commerce 2.4.6-p4發行說明

Adobe Commerce 2.4.6-p4是安全性版本，提供五個安全性修正，可增強您的Adobe Commerce 2.4.6或Magento Open Source 2.4.6部署。 它針對先前版本中發現的漏洞進行修正。
