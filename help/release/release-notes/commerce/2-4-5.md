...
**問題**：從2.4.5之前的產品版本升級至Adobe Commerce 2.4.6或更新版本後，暫存銷售規則標籤可能會不相符。 **因應措施**：在升級期間，在更新中繼資料步驟之前，套用ACSD-50625_2.4.5-P1.patch。 請參閱從版本&lt; 2.4.5[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27186)知識庫文章升級時的salesRules標籤問題。

解決此問題的一般步驟：

1. 下載必要的修補程式。 請參閱從版本&lt; 2.4.5[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27186)知識庫文章升級時的salesRules標籤問題。
