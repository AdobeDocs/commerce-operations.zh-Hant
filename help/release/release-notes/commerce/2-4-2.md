...
Adobe Commerce 2.4.2引進了效能和安全性的增強功能，以及重要的平台改善。 安全性增強功能包括擴充所有Cookie的`SameSite`屬性支援。 B2B改善著重於支援採購單的線上付款。 現在支援Elasticsearch7.9.x和Redis 6.x。
...
有關安全修補程式的一般資訊，請參閱 [新 安全修補程式版本](https://community.magento.com/t5/Magento-DevBlog/Introducing-the-New-Security-Patch-Release/ba-p/141287)簡介。 有關下載和應用安全修補程序（包括修補程序 2.4.1-p1）的說明，請参閱 [快速開始本地安裝](../../../installation/composer.md)。 安全修補程式僅包括安全錯誤修復，不包括完整修補程式中包含的其他安全增強功能。

## 其他發行資訊

雖然這些功能的程式碼已隨季度發行套件提供，但其中幾個專案(例如B2B、Page Builder和Progressive Web Application (PWA) Studio)也獨立發行。 這些專案的 Bug 修復記錄在每個專案的文件中提供的特定於專案的單獨發佈資訊中。
...
此版本已棄用設定安裝以使用分割資料庫的功能。 目前使用分割資料庫的商家，應開始計畫回覆或移轉至單一資料庫，或使用替代方法。 請參閱Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog文章中的[取代分割資料庫功能，以取得此問題的概觀。  如需移轉指示，請參閱[從分割的資料庫還原至單一資料庫](../../../configuration/storage/revert-split-database.md)。
...
* 新增對多個願望清單的支援。 您可以使用GraphQL來[建立](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html)、[刪除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html)和[重新命名](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html)願望清單，以及在它們之間移動](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html)或[複製](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html)個專案。<!-- MC-32356-->[

* 新增退貨授權(RMA)支援。 購物者可以[要求退貨](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html)。 如果商家接受要求，則購物者可以執行[新增註解](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html)和[新增追蹤資訊](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html)等工作。<!-- MC-34596-->

* 已新增對下列B2B功能的支援：
   * 公司。 您可以新增公司[管理員](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html)、[使用者](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html)、[角色](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html)和[團隊](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html)。<!-- MC-33861-->
   * 公司評價。 [公司查詢](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html)包含公司信用記錄的詳細資料。<!-- MC-33862-->
   * 請購單清單。 您可以[建立](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html)、[刪除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html)和[更新](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html)請購單清單。 支援還包括將[新增](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html)、[更新](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html)、[刪除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html)、[複製](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html)和[移動](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html)專案在請購單清單中，以及將請購單清單專案[新增到購物車](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html)的功能。<!-- MC-34312-->
...
**現在可以使用線上付款方式完成訂單**。 系統會提示B2B買家在初始結帳期間，為每個[採購單](https://experienceleague.adobe.com/en/docs/commerce-admin/b2b/purchase-orders/purchase-order-flow)選取其偏好付款方式。 核准採購單之後，系統會提示採購員輸入付款明細，以將採購單轉換為最終訂單。
...
* Page Builder不再要求將所有內容型別置入列。 [頁面產生器階段](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage)現在一開始是空白的，並支援將下列內容型別直接新增到階段：列、欄、索引標籤、HTML程式碼、區塊、動態區塊。

* 內容型別不再需要預先定義的邊界與內邊距。

* 表單欄位值的新行動[檢視區切換器](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports)和檢視區範圍可讓使用者和開發人員執行下列動作：
...
互動式產品內指導透過新功能公告、逐步說明指南、上線資訊和工具提示，為商家提供管理員內的使用提示和資訊。  如果未啟用此功能，**管理員必須從管理員選擇加入，才能收到產品內指南**。 檢視[使用情況資料集合](https://experienceleague.adobe.com/en/docs/commerce-admin/start/admin/admin)和[管理員使用情況](https://experienceleague.adobe.com/en/docs/commerce-admin/config/advanced/admin#admin-usage)。
...
MCOM聯結器與2.4.2完全相容。聯結器的錯誤修正和增強功能在[聯結器發行說明](https://omsdocs.magento.com/release-notes/connector/index.html)中說明。 此版本包含改進OMS命令列介面，現在提供詳細資訊，以供合作夥伴和支援團隊用於疑難排解`retry`、`queue_prune`、`order_sync`、`message process`和`catalog export`程式。

### 廠商開發的擴充功能

請參閱下列文章，瞭解此版本功能和變更的更新：

* [Amazon支付](https://marketplace.magento.com/amzn-amazon-pay-magento-2-module.html)。 Amazon Pay在此版本中已過時，將在Magento2.5.0中移除。2.4.3版及更新版本將僅包含相容性的更新及主要錯誤的修正。
...
* 此版本已棄用設定安裝以使用分割資料庫的功能。 請參閱Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog文章中的[取代分割資料庫功能。
...
* 安裝Adobe Commerce後，當您嘗試使用`ssh`容器變更`backend-frontname`時，應用程式不再擲回錯誤。 [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* 不再篩選按兩下介質集的“默認檢視書籤時顯示的內容。 之前，默認視圖包含從 applier 套 `url-filter` 用的篩選器。 [GitHub-1813](https://github.com/magento/adobe-stock-integration/issues/1813)、 [GitHub-1789](https://github.com/magento/adobe-stock-integration/issues/1789)、 [GitHub-1780](https://github.com/magento/adobe-stock-integration/issues/1780)

<!-- ENGCOM-8070 -->

* 邏輯已從所見即所得的插入控制器 （`Magento\Cms\Controller\Adminhtml\Wysiwyg\Images\OnInsert::execute()`） 中刪除並添加到 `Model\Wysiwyg\Images\PrepareImage::execute()` 模型中。 [GitHub-1504](https://github.com/magento/adobe-stock-integration/issues/1504)
...
* 管理員可從管理員SKU將產品新增至購物車，而無須從管理員重新導向。 管理員不再重定向到店面頁面，並且應用程式按預期在“管理購物車專案”部分中顯示產品。

<!-- MC-36750-->

* 現在，當您上傳包含多種類型錯誤的CSV文件時，應用程式會顯示信息性錯誤消息，此時SKU將產品添加到購物車。 以前，當您按兩下&#x200B;**「管理購物車**」上的「選擇檔案購物車」>****「依SKU **新增至購物車」時**，應用程式會顯示空白頁面和一般錯誤訊息。
...
* 現在，在貼文註銷後清理客戶會話時，應用程式會排除當前會話，密碼在登錄訪客購物者時重置。 以前，應用程式會在購物者重設其密碼時清空購物車。

<!-- MC-36884-->

* 現在，當購物者更改購物車中的商店視圖時，應用程式會显示商店視圖的正確默認國家/地区。 以前，在 購物車 中更改商店視圖時，默認的國家/地区不正確。
...
* 應用程式現在可在迷你購物車中正確呈現包含特殊字符的產品名稱。 [GitHub-29075](https://github.com/magento/magento2/issues/29075)
...
* 解決了店面上的產品排序順序問題。 先前，當應用程式將產品價格編列索引時，它偶爾會在`catalog_product_index_price`資料表中將可設定產品的`min_price`和`max_price`設定為0，這會影響店面的價格排序順序。

<!-- MC-35608-->

* 應用程式現在已成功更新標記為 `Product Type`的屬性。 以前，由於該屬性是在代碼中保留的，因此 `product_type` 當您嘗試更新 `Product Type` 屬性時，應用程式會顯示以下消息： `An attribute with the same code (product_type) already exists.`
...
* 現在只要&#x200B;**點按「**&#x200B;新增到購物車按鈕，「新增到購物車&#x200B;****」功能就會如預期般運作。以前，如果您在等待產品頁面載入時多次點擊此按鈕，應用程式會拋出此錯誤： `Invalid Form Key. Please refresh the page`。

<!-- MC-37006 36835-->

* 當商家在類別中添加或刪除禁用的產品時類別應用程式不再刷新緩存。 之前，應用程式會針對相關類別排清快取，無論產品狀態為何。 保存類別時也會取消分配類別，這會導致類別緩存刷新。
...
* 部分重新編列索引不再會導致遺漏產品和空白類別。

<!-- MC-38315-->

* 啟用「使用JavaScript日曆」**時，重新排序現在可按預期運作（**「儲存>****&#x200B;配置&#x200B;**」>**「目錄&#x200B;**」>**「日期和時間自定義」選項&#x200B;**）。**&#x200B;以前，啟用此設定後，當您嘗試從管理員重新排序之前下達的訂單時，應用程式會顯示此錯誤： `Please specify date required option(s)`。
...
* 從管理員啟用類別許可權不再會導致在重複訪問類別頁面期間無法在完全頁面緩存中緩存類別页面。 以前，後續的頁面造訪次數不會如預期從快取提供服務，而且效能會降低。
...
* `/V1/products/attributes/:attributeCode/options` REST 終結點現在支援更新現有屬性選項。

<!-- MC-30626 ENGCOM-8475-->

* 在多商店部署中，具有百分比價格的自定義選項的價格現在按預期轉換為活動商店的基礎貨幣。 以前，帶有百分比價格的自定義選項的價格轉換不正確。 [GitHub-26432](https://github.com/magento/magento2/issues/26432)

<!-- ENGCOM-8395 -->

* 商家現在可以在產品創建期間成功保存新屬性。 以前，當商家嘗試儲存屬性時，應用程式不會儲存屬性，並將商家重新導向至商店檢視首頁。 [GitHub-30362](https://github.com/magento/magento2/issues/30362)
...
* 目錄價格規則現在可正常適用於產品詳細數據頁面上的自定義選項。 之前，該頁面上的產品價格未反映適用的目錄價格規則。 [GitHub-22856](https://github.com/magento/magento2/issues/22856)
...
* 現在，按價格篩選缺貨可配置產品可在正確的價格範圍內顯示結果。

<!-- MC-38930-->

* 當虛擬產品的狀態從啟用更改為禁用時，虛擬產品將不再更改類型（反之亦然）。 以前，當產品的狀態更改時，應用程式將產品的類型從虛擬更改為簡單。

<!-- MC-38197-->

* `getValue()`更新購物車時，該方法不再觸發致命錯誤。
...
* 店面產品頁面現在按預期顯示不含稅的層價格。 [GitHub-12225](https://github.com/magento/magento2/issues/12225)
...
* 商家現在可以將值為 0（零）的特定於商店的文字色票屬性選項標籤保存。 以前，值 0 已替換為管理員標籤選項值。 [GitHub-30073](https://github.com/magento/magento2/issues/30073)
...
* 現在，當購物者在創建帳戶時輸入無效出生日期時，該應用程式會提醒購物者。 以前，驗證程式會忽略區域設置，並且購物者被重定向到建立新客戶帳戶頁面，並出現無效日期錯誤。

<!-- MC-38846-->

* 自訂位址屬性現在會如預期包含在結帳工作流程的「付款」步驟中。

<!-- MC-38114-->

* 自定義地址多選屬性現在可在客人結帳時以及管理員和我的帳戶訂單詳細信息頁面正確顯示。
...
* 現在從「管理員」刪除多個客戶的所有地址，會從客戶地址清單刪除所有地址，並移除預設帳單和送貨地址。 以前，應用程式從客戶地址中刪除了地址清單，但不會刪除預設的帳單和送貨地址。

<!-- MC-37377-->

* 管理員 客戶 地址標籤現在可以在管理員執行大量地址刪除後正確显示地址計數。 以前，該應用程式計數中包含已刪除的地址。
...
* 現在，當購物者在啟用了“啟用自動分配給客戶組&#x200B;**”的**&#x200B;商店中使用非預設客戶群組下訂單時，應用程式會將購物者分配給正確的客戶群組。[GitHub-26976](https://github.com/magento/magento2/issues/26976)

<!-- MC-39783-->

* 當在多網站部署中刪除非默認網站時，以及當索引設置為 **“按計劃**&#x200B;更新”時，管理員客戶網格現在按預期可用。 之前，應用程式 不會顯示網格並拋出此錯誤：  `[2020-12-09 11:31:54] report.CRITICAL: The website with id 2 that was requested wasn't found. Verify the website and try again. \{"exception":"[object] (Magento\\Framework\\Exception\\NoSuchEntityException(code: 0): The website with id 2 that was requested wasn't found. Verify the website and try again. at /var/www/html/magento24ee/vendor/magento/module-store/Model/WebsiteRepository.php:110)"}`

### dotdigital

* 從dotdigital Engagement Cloud檢索節目清單時，錯誤處理得到了改進。

* 在來賓同步期間在“商店名稱”列中同步的值現在按預期是商店視圖名稱。 以前，網站名稱已包含在此欄中。
...
* 在可下載產品獲得部分退款后，應用程式不再在我的下載產品標籤中列出可下載產品。 [GitHub-28388](https://github.com/magento/magento2/issues/28388)

### 動態區塊 （舊稱 橫幅）

<!-- MC-23938-->

* 刪除與應用程式關聯的客戶區段后，該不再在店面上显示動態区塊。

<!-- MC-37322-->

* 現在，在決定是否顯示動態區塊時，應用程式會正確地納入目錄帳戶價格規則。
...
* 已對`LoginAsCustomer`模組進行下列改良：
   ...
   * 以`isSetFlag`取代`(bool)->getValue()`。 [GitHub-29689](https://github.com/magento/magento2/issues/29689)
...
* 變更商店檢視時，應用程式不再將客戶重新導向首頁。 現在只有在第二個商店檢視找不到`$urlPath`時，`\Magento\VersionsCmsUrlRewrite\Model\StoreSwitcher::switch()`方法才會將購物者重新導向首頁。
...
* 一個缺失 `aclResource` 的屬性已新增至管理標題 `AdminNotification` 工具列區塊。 以前，當管理員用戶沒有查看角色資源許可權時，管理員通知工具列條目平均可見。 [GitHub-29067](https://github.com/magento/magento2/issues/29067)
...
* 預設管理會話期限已從加密模組移至安全模組。 [GitHub-30859](https://github.com/magento/magento2/issues/30859)
...
* 添加了規則以支援 `editorconfig` 將 JSON 和 YAML 檔縮進兩個空格。 [GitHub-30066](https://github.com/magento/magento2/issues/30066)、 [GitHub-30063](https://github.com/magento/magento2/issues/30063)

<!-- ENGCOM-8079 -->

* 該 `FlushCacheByTags` 類已更新為使用后外掛程式，而不是周圍外掛程式。 [GitHub-29558](https://github.com/magento/magento2/issues/29558)
...
* 外掛程式建立期間產生`Interceptor`時，應用程式不再擲回`Undefined class constant`錯誤。 [GitHub-28981](https://github.com/magento/magento2/issues/28981)，[GitHub-29879](https://github.com/magento/magento2/issues/29879)
...
* 修正佇列中數值引數轉換的問題。 先前，當您在`queue_topology.xml`中宣告含數值`type`引數的佇列時，引數值會轉換為字串。 [GitHub-29615](https://github.com/magento/magento2/issues/29615)
...
* 商家現在可以按預期取消指派類別中的產品。 之前，應用程式擲回與此錯誤類似的錯誤： `Could not save product "4" with position 0 to category 3`。
...
* 已復原`SelectedCustomizableOption.type`屬性。 此外，`CartItemInterface`的各種實作中的`customizable_options`屬性現在為非Null。
...
* 中影像檔案名稱 `vendor/magento/framework/File/Uploader.php` 不得超過90個字元的限制已移除。  以前，目錄和檔名的長度不能超過 255 個字元。 應用程式導入了文件名超出此限制的圖像的產品，但沒有導入影像檔案。 [GitHub-29377](https://github.com/magento/magento2/issues/29377)
...
* 現在在匯入包含圖像的 CSV 檔後，將刪除重複的產品圖像。 [GitHub-14398](https://github.com/magento/magento2/issues/14398)、 [GitHub-21885](https://github.com/magento/magento2/issues/21885)

## 指數

<!-- MC-38003-->

* 我們改進了部分索引器的性能。 應用程式現在會清除每次 1000 個 ID 批次反覆運算而變更的快取 ID。 快取內容不再累積ID。 以前，緩存上下文會為每個 1000 個 ID 的批量反覆運算累積緩存 ID，並在每次反覆運算時清除同一組 ID。
...
* 上傳者外掛程式新增了 `Mediagallery` 路徑驗證功能。 先前，驗證失敗，而且在&#x200B;**啟用舊媒體集**&#x200B;停用時，應用程式未匯入產品。 [GitHub-30649](https://github.com/magento/magento2/issues/30649)
...
* 已將重複性操作替換為 中的 `CheckStaticBlocksTest`操作組。 [GitHub-30561](https://github.com/magento/magento2/issues/30561)
...
* 已 `GoToAttributeGridPageActionGroup`棄用 。 [GitHub-30103](https://github.com/magento/magento2/issues/30103)

<!-- ENGCOM-8061 -->

* 向模組添加了 `Analytics` 操作組。 [GitHub-29500](https://github.com/magento/magento2/issues/29500)

<!-- ENGCOM-7334 -->

* 測試執行後更新`CheckCheckoutSuccessPageAsRegisterCustomerTest` 並`CheckCheckoutSuccessPageAsGuestTest` 取消已建立的訂單。 [GitHub-28324](https://github.com/magento/magento2/issues/28324)
...
* 導致跳過測試的問題 `StorefrontProductListWidgetWithSharedCatalogTest` 已得到解決。 [GitHub-322](https://github.com/magento/partners-magento2b2b/issues/322)
...
* 實作以 `AdminOpenCreateNewCMSPageActionGroup` 流覽以建立新的 CMS 頁面。 [GitHub-29824](https://github.com/magento/magento2/issues/29824)

<!-- ENGCOM-8268 -->

* 更正了 CMS 頁面媒體庫的 MFTF 測試中的跳過問題。 [GitHub-30164](https://github.com/magento/magento2/issues/30164)
...
* 現在，當客戶訂閱佇列的新聞稿時，管理員用戶可以照預期编辑帳戶客戶。 [GitHub-30645](https://github.com/magento/magento2/issues/30645)

<!-- ENGCOM-8034 -->

* 現在，如果應用程式未確認其新聞稿訂閱，購物者會重新發送新聞稿訂閱確認。 [GitHub-28422](https://github.com/magento/magento2/issues/28422)
...
* PayPal結算報表現在可按預期在「銷售報表」>**PayPal結算**>**取得****。**&#x200B;以前，應用程式不會在PayPal結算報表網格上清單這些報表，並顯示以下消息： `We couldn't find any records`。
...
* 應用程式現在會快取可設定產品的子 ID。 這通過減少資料庫請求的數量提高了頁面載入性能。 [GitHub-30585](https://github.com/magento/magento2/issues/30585)

<!-- MC-37594 -->

* 改進了管理控制面板的載入。 在過去，應用程式在頁面完成載入之前會以清單的形式显示標籤名稱。

<!-- MC-37417 -->

* 通過為佈局緩存添加到期限制，改進了 Redis 緩存管理。 以前，Redis 緩存在大型部署中會迅速達到分配的最大記憶體，並且應用程式在寫入操作時拋出錯誤。
...
* `Magento\Framework\DB\Adapter\Pdo\Mysql->isTableExists`已重構以改善效能。 用於 `SHOW TABLE STATUS` 檢查表是否存在的冗餘調用已減少。 [GitHub-29662](https://github.com/magento/magento2/issues/29662)

<!-- ENGCOM-8258 -->

* `getPageLayoutsConfig` 現在儲存在快取中，改善了設定建立工具的效能。 [GitHub-29546](https://github.com/magento/magento2/issues/29546)

<!-- MC-35614-->

* Adobe Systems 在包含超過 3,000,000 個客戶的細分客戶编辑和保存操作期間的商務性能已得到改進。
...
* 應用程式不再顯示&#x200B;**不是您嗎？** 當客戶記錄到啟用了永久性購物車的部署時選擇“ **記住我** ”選項時的文本。
...
* **「購物車**>**行銷**>**產品」報表**&#x200B;現在僅顯示產生報表之用戶所允許範圍內的記錄。以前，所有資料都可用於所有範圍。
...
* 最近查看“和”最近比較“產品功能現在可以在多商店部署中按預期在管理中顯示不同商店和網站的統計資訊。 以前，並非所有商店或網站帳戶這些功能。
...
* 分割RMA時，選取的選項現在會套用至分割明細專案。 以前，不會保存「退貨原因」、「物料狀況」和「解決方案」的值。

<!-- MC-35360-->

* 現在，您可以在啟用捆綁時刪除 RMA JavaScript跟蹤和運輸資訊。
...
* 現在，當您按兩下&#x200B;**管理員**&#x200B;行銷&#x200B;**「>**」所有評論&#x200B;**「上的」新審核**「按鈕時，新審核頁面將按預期載入」。按一下此頁面上的產品會開啟該產品預期的新檢閱表單。
...
* 現在，當部分訂單完成時，應稅訂單的獎勵積分將按預期計算。

<!-- MC-37244-->

* 商家現在可以成功為使用獎勵積分購買的訂單發放部分退款，並隨後退還剩餘的訂單。 以前，商家無法退還訂單剩餘的獎勵積分。

<!-- MC-37113-->

* 當購物者在刪除獎勵積分后重新應用獎勵積分時，應用程式不再显示此錯誤： `You removed the reward points from this order`。

<!-- MC-37032-->

* 現在，當客戶在支持多種貨幣的商店中使用非基礎貨幣下訂單時，獎勵積分會正確計算。
...
* 您現在可以從已啟用&#x200B;**使用JavaScript行事曆**&#x200B;的商店中，成功重新訂購具有自訂選項日期的產品。 以前，當您嘗試重新排序時，應用程式不會將專案添加到購物車並显示此錯誤： `Could not add the product with SKU "simp1" to the shopping cart: Please specify date required option(s).`

<!-- MC-36533-->

* 在啟用了零小計結帳方法的部署中，當購物者簽出包含總成本為 0 美元的虛擬產品的訂單時，應用程式不再立即關閉訂單。

<!-- MC-36755-->

* 應用程式不再在處理訂單前將其存檔。 先前，管理員訂單網格線上的多選動作會影響未選取的訂單。

<!-- MC-37371-->

* 當沙特里亞爾 （SAR） 設置為基礎貨幣時，貸項通知單網格現在顯示正確的貨幣符號。

<!-- MC-37880-->

* 應用程式現在可在結帳時，如預期在訂單頁面上一致地顯示送貨地址信息。
...
* 異步發送銷售電子郵件現在僅向上次更新日期之後創建的訂單發送電子郵件。 以前，在啟用異步發送時，應用程式不會按日期篩選電子郵件。
...
* 購物者套用優惠券代碼的頻率不能超過&#x200B;**每位客戶使用次數**&#x200B;設定許可。 以前，如果購物者打開了多個瀏覽器窗口並同時下了多個訂單，則每個訂單都會獲得折扣，平均儘管“ **每個客戶的** 使用”設置的值為 **1**。

### 搜索 {#search-heading}

<!-- MC-35095-->

* Elasticsearch 當購物者搜索搜尋同義詞時，不再引發未知修飾符錯誤。 以前，escaper 在正則表達式中缺少轉義斜杠符號，這導致了致命錯誤。
...
* 搜尋結果中產品名稱Elasticsearch類型不再區分大小寫。
...
* 目錄搜尋的效能已改善。 停用&#x200B;**啟用搜尋建議** （**存放區** > **組態** > **目錄** > **目錄搜尋** ）如預期般運作。 以前，應用程式查詢 MySQL `search_query` 表而不是自動填充搜尋建議的 Elasticsearch。 [GitHub-25534](https://github.com/magento/magento2/issues/25534)

<!-- MC-35256-->

* Elasticsearch現在篩選器產品價格與MySQL相同。 在Elasticsearch索引中，欄位型別`price_*`已從`float`變更為`double`，以提高精確度並更正浮點錯誤。
...
* 優化產品詳情頁面載入。 我們為資料庫表添加了索引，這些資料庫表在許多情況下優化目標規則條件查詢。

<!-- MC-36288-->

* 當用於「要顯示的產品」功能的條件包含多個條件時， `is one of` 相關產品的Target規則現在有效。 以前，當此條件包含多個值時，不會對其進行解析。

### 稅

<!-- MC-37666-->

* 客人訂單的增值稅驗證不再導致應用程式使用不正確的客户稅級保存報價。 [GitHub-30018](https://github.com/magento/magento2/issues/30018)
...
* `dev/tests/integration/testsuite/Magento/Customer/Controller/AccountTest` 已改進。 （`assert`現在以`XPath`選擇器為基礎，而非`assertStringContainsString`。） [GitHub-29700](https://github.com/magento/magento2/issues/29700)
...
* 整合和 API 功能測試現在與 PHPUnit 9.3 相容。 [GitHub-30146](https://github.com/magento/magento2/issues/30146)

<!-- MC-35798 8109-->

* 修正 GraphQL `testRequestCacheTagsForCategoryListOnMultipleIds` 測試的問題。 [GitHub-29372](https://github.com/magento/magento2/issues/29372)
...
* 已移除管理員主題中模組中的多餘代碼 `Magento_ConfigurableProduct` 。  [GitHub-29857](https://github.com/magento/magento2/issues/29857)
...
* 當管理員區域設置為 阿拉伯文 （`ar_SA - Saudi Arabia`） 時，「管理員訂單」網格日期選取器現在按預期工作。

<!-- MC-38476 -->

* 當購物者在註冊或添加新地址時使用有效的貼文碼輸入阿根廷地址時，應用程式不再显示錯誤消息。 之前，應用程式顯示此錯誤： `Provided Zip/Postal Code seems to be invalid. Example: 1234. If you believe it is the right one you can ignore this notice.`

<!-- MC-38663-->

* 當購物者輸入 韓文 地址的五位數郵政編碼時，應用程式不再引發錯誤。

<!-- ENGCOM-8244 -->

* 添加了對 ISO 3166-2：UY](https://en.wikipedia.org/wiki/ISO_3166-2:UY) 中[定義的烏拉圭地區的支援。[GitHub-29729](https://github.com/magento/magento2/issues/29729)

<!-- ENGCOM-8220 -->

* `zip_codes.xml` 已更新為巴西郵遞區號強制使用八位數。 [GitHub-29984](https://github.com/magento/magento2/issues/29984)

<!-- ENGCOM-8304 -->

* 改進剩餘未當地語系化片語的當地語系化。 [GitHub-11175](https://github.com/magento/magento2/issues/11175)
...
* 現在，應用程式只會在模組啟用後下載內聯翻譯JavaScript。  [GitHub-29553](https://github.com/magento/magento2/issues/29553)

### 用戶介面

<!-- MC-38509-->

* **當購物者輸入無效數據時，按鈕帳戶建立新帳戶頁面上的建立**&#x200B;保持活動狀態。以前，此按鈕處於禁用狀態，因此無法在發生錯誤後重新嘗試創建帳戶。 這是 2.4.1 中的已知問題。 [GitHub-30513](https://github.com/magento/magento2/issues/30513)

<!-- MC-38698-->

* 改進了管理訂單編輯頁面上裝運網格線的載入。
...
* 定義有限寬度的 CSS 類現在按預期&#x200B;**應用於管理存儲**>**>****目錄 XML 網站地圖**>**生成設定**&#x200B;上的&#x200B;**“開始時間**”字段> **** 配置目錄。[GitHub-29496](https://github.com/magento/magento2/issues/29496)
...
* `Vault`模組現在會從付款資訊管理服務的要求中辨識付款方式代碼。 先前，當購物者使用已儲存的Braintree信用卡下訂單時，即使使用有效的付款方式，應用程式也會擲回此錯誤： `The requested Payment Method is not available`。
...
* 提供`save_rewrites_history`自訂屬性時，PUT`V1/categories/:id`端點現在會儲存為類別URL金鑰建立301重新導向所需的資料。 [GitHub-29174](https://github.com/magento/magento2/issues/29174)，[GitHub-30240](https://github.com/magento/magento2/issues/30240)
...
**問題**： `[magento_root]/index.php`該文件已被移除，對於 Apache 配置，應用程式現在預設從中 `/pub` 運行。 從子資料夾提供的存放區將無法如預期運作，並可能顯示404錯誤。 **因應措施**：使用symlink將安裝模擬至子資料夾。 下列範例使用兩個存放區（`https://shop01.com/shop/`和`https://shop02.com/shop/`）來說明如何使用symlink來模擬子資料夾中的安裝。
...
1. 在新目錄 （`magento_root/pub/shop01/index.php`） 中建立一個`index.php`文件並添加此內容：
...
1. 將您的 Apache 伺服器設定為指向新的子目錄。 部署配置可能會有很大差異。 下面是一個範例伺服器設定：
...
**問題**：商家必須從管理員啟動快速強制 TLS 功能，才能為所有商店頁面啟用全域 HTTP 到 HTTPS 重新導向。 請參閱將 [HTTP 重新導向至 HTTPS 雲端上所有頁面 （強制 TLS）](https://support.magento.com/hc/en-us/articles/360006296953) 知識庫文章。 <!-- MC-39988-->
...
**問題**：當購物者按一下&#x200B;**使用Venmo**&#x200B;付款時，應用程式會按預期在Braintree中建立訂單，但未在Admin中建立訂單。 **因應措施**：無。 請參閱[2.4.2已知問題：BraintreeVenmo付款無法運作](https://support.magento.com/hc/en-us/articles/360054662652/)知識庫文章。 <!-- BUNDLE-2894-->
...
**問題**：當買家創建採購訂單，然後導航到結帳頁面時，應用程式有時會顯示 404 錯誤。 如果買方之前使用線上付款方式創建了其他採購訂單，然後在未完成上一次購買的情況下導航到結帳頁面，則會發生此錯誤。 採購員仍然可以下採購單。 **解決辦法**：無。 <!-- B2B-1605-->

**問題**：在採購訂單結帳期間平均買家在最終結帳時更改付款方式時，特定付款方式的折扣仍然存在。 因此，客戶可能會獲得他們無權享受的折扣。 發生此狀況是因為儘管付款方式有所變更，原始付款方式的購物車規則仍會套用。 **因應措施**：無。 請參閱[2.4.2 B2B已知問題：付款方式變更後，線上採購單的折扣仍會保留](https://support.magento.com/hc/en-us/articles/360054667312)知識庫文章。<!-- B2B-1012 -->
...
[Code 遷移工具包](https://github.com/magento-commerce/code-migration)有助於將現有的 Magento 1.x 商店擴展和自定義傳輸到 Magento 2.x。命令列介面包含用於轉換 Magento 1.x 模組和佈局的腳本。
