...
如需安全性修補程式的一般資訊，請參閱[安全性修補程式發行說明](../security/overview.md)。 如需有關下載和套用安全性修補程式（包括修補程式2.4.1-p1）的說明，請參閱[快速入門內部部署](../../../installation/composer.md)。 安全性修補程式僅包含安全性錯誤修正，不包含完整修補程式中包含的其他安全性增強功能。
...
* [Amazon支付](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html)。 Amazon Pay已在此版本中淘汰，並將在Magento 2.5.0中移除。 2.4.3版及更新版本將僅包含相容性的更新及主要錯誤的修正。
