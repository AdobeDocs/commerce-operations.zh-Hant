...
由[Adobe AI](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview)支援的[即時搜尋](https://business.adobe.com/ai.html)使用人工智慧和機器學習演演算法，對彙總的訪客資料執行深入分析，提供直覺式的搜尋體驗。 請參閱[即時搜尋發行說明](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html)。
