...
由[Adobe AI](https://business.adobe.com/ai.html)支援的[即時搜尋](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview)使用人工智慧和機器學習演演算法，對彙總的訪客資料執行深入分析，提供直覺式的搜尋體驗。 請參閱[即時搜尋發行說明](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html)。
...
* [Amazon支付](https://commercemarketplace.adobe.com//amzn-amazon-pay-magento-2-module.html)。 Amazon Pay已淘汰，並將在較新的2.4.x版本中移除。 2.4.3版及更新版本將僅包含相容性的更新及主要錯誤的修正。
