...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>為了將混淆最小化，[!UICONTROL Submit Comment]訂單詳細資料[!UICONTROL Update]頁面中的<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order">按鈕標籤變更為</a>。</td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
           ...
           <td>此版本包含下列客戶管理增強功能：
             <ul>
               ...
               <li><!--LYNX-566-->已在<code>customer.addressesV2</code>查詢中新增<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/customer/"><code>customer</code></a>欄位，新增客戶地址的分頁功能。</li>
             </ul>
           </td>
        </tr>
        <tr>
           ...
           <td>此版本包含下列使用者訂單管理增強功能：
             <ul>
              ...
              <li><!--LYNX-449-->已新增類似於<code>OrderItemPrices</code>的<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CartItemPrices"><code>CartItemPrices</code></a>型別至<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-OrderItemInterface"><code>OrderItemInterface</code></a>，其中包含數個新的價格欄位。</li>
              ...
              <li><!--LYNX-642-->更新<code>order.availableActions</code>欄位，以確保在商人<code>REORDER</code>停用<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders">管理員中的重新排序功能時，不會傳回</a>動作。</li>
              ...
              <li><!--LYNX-470-->已根據<code>created_at</code>欄位新增訂單歷史記錄篩選器，並公開具有<code>date_of_first_order</code>型別的<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrders"><code>CustomerOrders</code></a>。</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->已在<code>quantity</code>中新增<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-ProductInterface"><code>ProductInterface</code></a>欄位，以提供庫存等級詳細資料。 它會根據管理員設定顯示可用庫存或Null。</li>
