...
Adobe Commerce 2.4.8提供增強的安全性、與PHP 8.4和MariaDB 11.4的相容性、加速移轉至由Edge Delivery支援的新[Adobe Commerce店面](https://experienceleague.adobe.com/developer/commerce/storefront/)的廣泛GraphQL API改進，以及超過500項品質修正和增強功能，以提升現有功能。 升級至2.4.8可讓您的平台安全無虞、配合最新的技術進步，並且支援至2028年4月。

>[!BEGINSHADEBOX]

**採用建議**

在規劃升級至Adobe Commerce 2.4.8時，請考慮您的業務優先順序、目前版本，以及採用新[Adobe Commerce as a Cloud Service](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/overview)的計畫。
    ...
    <tbody>
        <tr>
            ...
            <td>此版本包含下列安全性設定的增強功能：
              <ul>
                <li><strong>Duo Security 2FA</strong>：此變更會更新Adobe Commerce中的<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/tfa/security-two-factor-authentication-use#duo-security">Duo Security</a>雙因素驗證(2FA)實作，以使用最新的SDK (Web SDK v4)。 此升級可讓商家順暢地轉換至使用Duo Universal Prompt。 商家必須在管理員設定中更新其設定，以包含使用者端ID和密碼。<!-- AC-10982 --></li>
                <li><strong>加密金鑰</strong>： <!-- AC-12679 -->重新設計管理加密金鑰，以改善使用性，並消除先前的限制和錯誤。 新的CLI命令現在可用於<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/encryption-key">變更</a>金鑰和<a href="https://developer.adobe.com/commerce/php/development/security/data-encryption/">重新加密</a>特定系統組態、付款和自訂欄位資料。 此版本不再支援變更管理員UI中的索引鍵。 您必須使用CLI指令。 如需詳細資訊，請參閱<a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/troubleshooting-encryption-key-rotation-cve-2024-34102">疑難排解加密金鑰輪換： CVE-2024-34102</a>知識庫文章。</li>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>此版本新增對RabbitMQ 4.x的支援。 在升級至RabbitMQ 4之前，Adobe Commerce Cloud和內部部署客戶必須<a href="https://www.rabbitmq.com/docs/3.13/migrate-mcq-to-qq">從[!DNL classic mirrored queues]移轉至[!DNL quorum queues]</a>。 需要進行此移轉，因為：<ul>
        ...
        <tr>
            ...
            <td>Adobe Commerce現已針對OpenSearch 2.19最佳化，不再與Elasticsearch相容。 程式碼基底現在已不建議使用所有Elasticsearch 7和8模組及類別。 Adobe強烈建議針對內部部署和雲端基礎結構部署轉換至OpenSearch，以確保持續的支援和相容性。 請參閱<a href="/help/upgrade/prepare/opensearch-migration.md">移轉至OpenSearch</a>。<ul>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
                <li><!--LYNX-387-->已將下列新欄位新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a>型別，以支援精確的定價顯示和折扣計算：
                <ul>
              ...
              <li><!--LYNX-542-->更新<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/mutations/update-items"><code>updateCartItems</code></a>突變，傳回包含錯誤詳細資料（而非例外）的成功回應。 增強錯誤對應以提高使用者通知的清晰度。</li>
              ...
              <li><!--LYNX-451-->已將<code>grand_total_excluding_tax</code>欄位新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartprices"><code>CartPrices</code></a>型別，提供明確的含稅定價。</li>
              <li><!--LYNX-377-->已新增<code>not_available_message</code>至<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/interfaces/"><code>CartItemInterface</code></a>。</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>此版本包含下列客戶管理增強功能：
             <ul>
               <li><!--LYNX-391-->改進<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/generate-token"><code>generateCustomerToken</code></a>突變中的錯誤處理，為未確認的電子郵件提供特定訊息。 支援更佳的使用者指引和錯誤解決方案。</li>
        ...
        <tr>
           ...
           <td>此版本包含下列使用者訂單管理增強功能：
             <ul>
              ...
              <li><!--LYNX-470-->已新增新的<code>date_of_first_order</code>欄位至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a>型別。</li>
              <li><!--LYNX-468-->擴充<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderaddress"><code>OrderAddress</code></a>型別以包含自訂屬性，增強訂單詳細資料的可見度。 支援在訂單確認頁面上顯示的其他資訊。</li>
              <li><!--LYNX-450-->已將<code>is_virtual</code>欄位新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>型別，支援虛擬產品識別。 藉由區分虛擬與實體產品來增強訂單處理能力。</li>
              <li><!--LYNX-449-->已新增類似於<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a>的<code>OrderItemPrices</code>型別至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderiteminterface"><code>OrderItemInterface</code></a>，其中包含數個新的價格欄位。</li>
              <li><!--LYNX-448-->改善API功能，以根據電子郵件比對來合併來賓訂單與客戶帳戶。 簡化回頭客戶的訂單管理。</li>
              <li><!-- LYNX-523: -->已擴充<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>型別以包含<code>available_actions</code>欄位，以便進行更好的訂單管理。 「available_actions」欄位對應至列示可針對訂單執行之可能動作的列舉。</li>
              <li><!-- LYNX-524 -->已將<code>customer_info</code>欄位新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>型別。 此欄位需要<code>OrderCustomerInfo</code>型別，其中包含有關客戶名稱的詳細資料。</li>
              <li><!--LYNX-519-->已將詳細的錯誤碼新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cancelorderoutput"><code>CancelOrderOutput</code></a>型別。 改善訂單取消流程的錯誤處理和使用者回饋。</li>
              ...
              <li><!--LYNX-642-->更新<code>order.availableActions</code>欄位，以確保在商人<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders">停用</a>管理員中的重新排序功能時，不會傳回<code>REORDER</code>動作。</li>
              ...
              <li><!--LYNX-470-->已根據<code>created_at</code>欄位新增訂單歷史記錄篩選器，並公開具有<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a>型別的<code>date_of_first_order</code>。</li>
              <li><!--LYNX-450-->已將<code>is_virtual</code>欄位新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>型別，類似於<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cart"><code>Cart</code></a>型別。 這可讓客戶有條件地隱藏只包含虛擬產品的訂單的送貨資訊。</li>
              ...
              <li><!--LYNX-701-->更新<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>型別以包含套用至訂單總計的商店點數和獎勵點數。 現在，訂單裝載會傳回商店評分和獎勵點的標籤和值，以確保完整的成本摘要詳細資料。</li>
            </ul>
           </td>
        </tr>
        <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->已在<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#productinterface"><code>ProductInterface</code></a>中新增<code>quantity</code>欄位，以提供庫存等級詳細資料。 它會根據管理員設定顯示可用庫存或Null。</li>
              <li><!--LYNX-460-->修正套件產品的定價顯示，確保價格與貨幣資訊準確無誤。</li>
              <li><!--LYNX-401-->已新增<code>grouped_product_image</code>和<code>configurable_product_image</code>欄位至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a>型別。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-713-->更新<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftoptionsprices"><code>GiftOptionsPrices</code></a>和<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a>型別，以包含贈品包裝（依料號與訂單）與列印卡片的<code>price_excluding_tax</code>和<code>price_including_tax</code>欄位。 此增強功能可確保根據購物車和訂單查詢的商店組態設定，準確顯示稅捐。</li>
              ...
              <li><!--LYNX-693-->已新增<code>gift_message</code>和<code>gift_wrapping</code>欄位至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftcarditem"><code>GiftCardCartItem</code></a>型別；已更新邏輯以捨棄虛擬產品的贈品包裝。</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-632-->更新RMA專案輸入的<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a>突變，以解決傳回屬性相關查詢與突變之間的不一致。</li>
                <li><!--LYNX-515-->更新<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a>突變以支援客體訂單退貨。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-633-->已更新<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a>型別（包含欄位），以符合管理員設定中的稅捐顯示設定。</li>
                <li><!--LYNX-697-->已新增<code>subtotal_excl_tax</code>和<code>subtotal_incl_tax</code>欄位至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a>型別。 已將<code>subtotal</code>欄位標示為已棄用。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-618-->已在<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartaddressinterface"><code>CartAddressInterface</code></a>型別中新增送貨或帳單購物車位址的通訊錄識別碼。</li>
                <li><!--LYNX-617-->已將<code>same_as_billing</code>欄位新增至<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#shippingcartaddress"><code>ShippingCartAddress</code></a>型別，以指出送貨地址與帳單地址是否相同。</li>
                <li><!--LYNX-458-->更新<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order"><code>guestOrder</code></a>和<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token"><code>guestOrderByToken</code></a>查詢以包含自訂地址屬性，確保新帳戶的完整地址資訊。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-522-->已新增<code>theme</code>欄位至<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/recaptcha-v3-config"><code>recaptchaV3Config</code></a>查詢。 此欄位可讓您指定用於轉譯reCaptcha的主題名稱，以確保精確的價格和貨幣資訊。</li>
