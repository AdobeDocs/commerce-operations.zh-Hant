    ...
    <tbody>
        <tr>
            ...
            <td>此版本包含下列安全性設定的增強功能：
              <ul>
                <li><strong>Duo Security 2FA</strong>：此變更會更新Adobe Commerce中的<a href="https://experienceleague.adobe.com/zh-hant/docs/commerce-admin/systems/security/tfa/security-two-factor-authentication-use#duo-security">Duo Security</a>雙因素驗證(2FA)實作，以使用最新的SDK (Web SDK v4)。 此升級可讓商家順暢地轉換至使用Duo Universal Prompt。 商家必須在管理員設定中更新其設定，以包含使用者端ID和密碼。<!-- AC-10982 --></li>
