    ...
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-731-->新增GraphQL擷取購物車規則資訊的支援。 引入新商店設定以控制所有和套用的購物車規則的曝光，以及用於擷取使用中購物車規則的<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/queries/all-rules/"><code>allCartRules</code></a>查詢和<code>Cart.rules</code>欄位。</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>此版本包含下列客戶管理增強功能：
             <ul>
               ...
               <li><!--LYNX-773-->已新增新的<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/segments/"><code>customerSegments</code></a>查詢以啟用個人化功能。</li>
               <li><!--LYNX-729-->已新增<code>customerGroup</code>查詢，以傳回來賓和客戶的客戶群組相關資訊。</li>
               <li><!--LYNX-732-->新增管理客戶群組的商店設定、引入<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/all-groups/"><code>allCustomerGroups</code></a>查詢以擷取所有可用客戶群組清單，並公開<code>Customer.group</code>欄位以存取目前登入客戶的群組資訊。</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-730-->已新增目錄定價規則的存放區設定、新增<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/all-rules/"><code>allCatalogRules</code></a>查詢以擷取所有可用的目錄規則，並公開<code>Product.rules</code>欄位以顯示目前套用至產品的目錄規則。</li>
