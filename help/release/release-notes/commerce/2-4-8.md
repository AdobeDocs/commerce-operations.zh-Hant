...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>為了將混淆最小化，[!UICONTROL Submit Comment]訂單詳細資料[!UICONTROL Update]頁面中的<a href="https://experienceleague.adobe.com/zh-hant/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order">按鈕標籤變更為</a>。</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
           ...
           <td>此版本包含下列使用者訂單管理增強功能：
             <ul>
              ...
              <li><!--LYNX-642-->更新<code>order.availableActions</code>欄位，以確保在商人<code>REORDER</code>停用<a href="https://experienceleague.adobe.com/zh-hant/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders">管理員中的重新排序功能時，不會傳回</a>動作。</li>
