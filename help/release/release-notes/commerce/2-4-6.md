...
此版本推出Adobe Commerce擴充功能中繼套件v1.1.0，自動將特定Adobe Commerce擴充功能與此核心版本整合。 在下列情況下，將會安裝此中繼套件中包含的這些擴充功能版本： `composer update` 在升級至最新核心版本時，會簡化升級這些擴充功能的程式。 這些擴充功能仍會維持獨立的發行排程。
