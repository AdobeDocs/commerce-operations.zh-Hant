...
此版本已移除PHP 7.4支援。 不能在PHP 7.4上運行Adobe Commerce 2.4.6。
...
* [螺栓快速結帳](https://experienceleague.adobe.com/docs/commerce-merchant-services/quick-checkout/overview.html)
...
* 採購訂單GraphQL結構涵蓋B2B公司使用者的採購訂單管理功能，例如建立、編輯和刪除採購訂單。 請參閱 [採購訂單(B2B)](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/purchase-order/).
* 採購訂單規則GraphQL架構提供建立、編輯和刪除審批規則以及人工驗證採購訂單的功能。 請參閱 [採購訂單批准規則(B2B)](https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/purchase-order-rule/).
...
* Adobe Commerce現在會在 `addProductsToCart` 在權限不足的情況下將產品新增至購物車時，變異會失敗。
