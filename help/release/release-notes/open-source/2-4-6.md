...
此版本已移除PHP 7.4支援。 無法在PHP 7.4上運行Magento Open Source。
...
* Magento Open Source現在會在 `addProductsToCart` 將產品新增至購物車時，權限不足時，查詢會失敗。
...
* Magento Open Source不再錯誤地假設某個類別是根據類別路徑的另一個類別的父項。 [GitHub-32464](https://github.com/magento/magento2/issues/32464)
...
* Magento Open Source不再錯誤地假設某個類別是根據類別路徑而另一個類別的父類別。 以前，當兩個類別相鄰，且一個類別ID以另一個類別的類別ID開頭時，Magento Open Source會假設這些類別具有相同的父類別。 [GitHub-32464](https://github.com/magento/magento2/issues/32464)
