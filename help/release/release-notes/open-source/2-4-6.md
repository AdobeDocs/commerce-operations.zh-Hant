...
Magento Open Source 2.4.6推出對PHP 8.2的支援。PHP 8.1仍完全受支援。<!-- AC-6598 -->
...
新的`adobe-ims-metapackage` v2.2.0已與Adobe Commerce 2.4.6和Magento Open Source 2.4.6整合。此版本未變更任何功能。<!-- CABPI-505-->
...
* 將折扣套用至運送成本時，Magento Open Source不再擲回最小訂單金額錯誤。
