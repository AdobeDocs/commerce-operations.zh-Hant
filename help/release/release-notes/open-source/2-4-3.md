...
[升級相容性工具](https://experienceleague.adobe.com/docs/commerce-operations/upgrade-guide/upgrade-compatibility-tool/overview.html?lang=zh-Hant)的範圍已根據社群的意見展開。 加入我們的[#upgrade-compatibility-tool](https://magentocommeng.slack.com/archives/C019Y143U9F)Slack頻道，取得Adobe產品團隊和社群的支援，並幫助引導工具的未來方向。
