...
除了[Braintree](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/payments/braintree)之外，所有廠商隨附的擴充功能已從Magento Open Source2.4.4程式碼基底中移除。 商戶應移轉至可在[Commerce Marketplace](https://marketplace.magento.com/extensions.html)上取得的正式副檔名。
...
**問題**：從 Adobe Systems Commerce 2.4.4 升級到 Adobe Systems Commerce 2.4.4-p1 的過程中，商家可能會注意到軟體包版本降級通知。 可以忽略這些消息。 包版本的差異是由於包生成期間的異常造成的。 沒有任何產品功能受到影響。 請參閱從2.4.4升級為2.4.4-p1](https://support.magento.com/hc/en-us/articles/8214752983949)知識庫文章後降級的[套件，瞭解受影響的案例和因應措施。
