...
**問題**：在安裝PHP 7.4.2的部署中，店面錯誤訊息發生異常。 當使用PHP 7.4.2部署2.4.0時，店面錯誤訊息中的空格符號會被替換為加(+)字元。  此錯誤是PHP 7.4.2的原生錯誤，無法由Magento Open Source更正。 **因應措施**：建議您使用其他版本的PHP 7.4.x。請參閱店面[知識庫文章中的](https://support.magento.com/hc/en-us/articles/360045804332)原始訊息資料顯示。<!-- MC-34170-->
