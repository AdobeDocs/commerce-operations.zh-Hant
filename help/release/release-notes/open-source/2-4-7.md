---
title: Magento Open Source 2.4.7 — 測試版2發行說明
description: 瞭解2.4.7-beta2Magento Open Source版本中的新功能、增強功能、錯誤修正和已知問題。
...
# Magento Open Source 2.4.7 — 測試版2發行說明
...
Magento Open Source2.4.7-beta2包含200多項品質修正和增強功能。 核心撰寫器相依性和協力廠商程式庫已升級至最新可用版本。
...
Magento Open Source2.4.7-beta2已針對下列元件版本進行測試：
...
## Magento Open Source2.4.7 - beta2重要功能

請檢視此版本中的下列重點專案。

### 安全性增強功能

此發行版本引進了十項安全性修正和平台安全性改善。 Adobe Commerce 2.4.7之前的測試版推出13項安全性修正及平台安全性改善。
...
Magento Open Source2.4.7-beta1引進了以下增強功能，這會變更現有REST端點的預設行為：
...
Magento Open Source 2.4.7-beta2推出這些平台升級：
...
* Commerce FedEx REST API已更新，以與更新的FedEx網路服務相容，將於2024年5月發行。 此版本不包含FedEx SOAP支援。 <!-- AC-1470 -->
...
此發行版本包含Magento Open Source擴充功能中繼套件v1.0.0-beta1，可自動套件組合 [付款服務](https://experienceleague.adobe.com/docs/commerce-merchant-services/payment-services/guide-overview.html) 擴充功能搭配此核心版本。 此中繼資料中包含的此擴充功能版本，會在 `composer update` 會執行，以簡化升級至最新核心發行版本時升級擴充功能的程式。 此擴充功能會維護獨立的發行排程。
...
* 此 `addProductsToCart` 突變現在已成功將禮品卡新增到購物車。 以前，此查詢需要禮品卡收件者名稱，但會傳回寄件者名稱。 Magento Open Source擲回此錯誤： `Please specify a recipient name`. [GitHub-36665](https://github.com/magento/magento2/issues/36665)
...
* 此 **卡片安全性代碼不符** 現在會在「付款流程專家」付款處理期間，依預期處理組態。 以前，此評估流程永遠不會完成，這會阻止簽出。
...
<!-- ACP2E-2034 -->
Magento Open Source現在會顯示具有特殊價格的固定套件產品的正確價格。 這是2.4.7-beta1的已知問題。
...
下列已知問題將在Magento Open Source2.4.7-beta3中修正：
...
您可以使用以下工具安裝Magento Open Source2.4.7-beta2： [作曲者](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html).
