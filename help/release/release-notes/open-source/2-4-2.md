...
此版本已棄用設定安裝以使用分割資料庫的功能。 目前使用分割資料庫的商家，應開始計畫回覆或移轉至單一資料庫，或使用替代方法。 請參閱Magento Open Source[&#x200B; DevBlog文章中的](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187)取代分割資料庫功能，以取得此問題的概觀。  如需移轉指示，請參閱[從分割的資料庫還原至單一資料庫](../../../configuration/storage/revert-split-database.md)。
...
* 此版本已棄用設定安裝以使用分割資料庫的功能。 請參閱Magento Open Source[&#x200B; DevBlog文章中的](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187)取代分割資料庫功能。
...
* 安裝Magento Open Source後，當您嘗試使用`backend-frontname`容器變更`ssh`時，應用程式不再擲回錯誤。 [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* 當`products`時，`category_id`查詢現在會傳回預期的結果  使用`in`關鍵字指定篩選器。 [GitHub-30349](https://github.com/magento/magento2/issues/30349)
