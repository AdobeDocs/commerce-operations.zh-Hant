...
* 使用建立新商店時，新商店的URL產生現在可如預期運作 `bin/magento setup:config:import`. 之前，生產環境中不會產生URL重新寫入。 [GitHub-30025](https://github.com/magento/magento2/issues/30025)
...
* GraphQL URL解析器現在可以正確處理CMS頁面階層。 以前它返回NULL。 [GitHub-30474](https://github.com/magento/magento2/issues/30474)
...
* 現在，當GraphQL密碼重設作業期間發生錯誤時，應用程式會傳回資訊更豐富的訊息。 [GitHub-30179](https://github.com/magento/magento2/issues/30179)
