...
指定關聯陣列，其中索引鍵是來自[\\Magento\\App\\Filesystem\\DirectoryList](https://github.com/magento/magento2/blob/2.4/lib/internal/Magento/Framework/App/Filesystem/DirectoryList.php)的常數，而值分別是目錄的絕對路徑或其URL路徑。
