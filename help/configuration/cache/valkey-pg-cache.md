...
- **Zend快取（2.4.8和更早版本）** — Commerce 2.4.8和更早版本的Valkey後端：
  - **Zend型Valkey後端** — 使用完整的類別路徑(`Magento\Framework\Cache\Backend\Valkey`)
...
- **Symfony快取(2.4.9+)** — 從Commerce 2.4.9開始，Symfony快取為Valkey提供PSR-6相容的快取實作，並大幅改善效能：
