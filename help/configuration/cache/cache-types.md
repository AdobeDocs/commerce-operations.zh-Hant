...
- `<frontend_type>` — 低階前端快取型別。 指定與`Zend\Cache\Core`相容的類別名稱。如果省略，則使用[Magento\Framework\Cache\Core](https://github.com/magento/magento2/blob/2.4/lib/internal/Magento/Framework/Cache/Core.php)。
