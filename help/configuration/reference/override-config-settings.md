...
>[!TIP]
>
>查看 [配置環境](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/env/stage/variables-intro.html) 主題 _雲基礎架構上的商務指南_。
...
>
>- 對於雲基礎架構上的Adobe Commerce，如果您嘗試使用 [Project Web介面](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/project/overview.html#configure-the-project)，必須在變數名前加上 `env:`。 例如：
>
>![環境變數示例](../../assets/configuration/cloud-console-envvariable.png)
