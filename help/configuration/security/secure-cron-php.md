---
title: 安全cron PHP
description: 瞭解如何限制瀏覽器對pub/cron.php的存取，並保護Adobe Commerce排程工作免受未經授權或惡意的cron執行。
...
1. 一或多個使用者的&#x200B;_Cron存取權。_ 以下列專案取代現有的`<Files cron.php>`指示詞：
...
1. 群組&#x200B;_Cron存取權。_ 以下列專案取代現有的`<Files cron.php>`指示詞：
