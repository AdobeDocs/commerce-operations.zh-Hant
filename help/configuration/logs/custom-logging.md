...
Commerce 2符合PSR-3標準。 依預設，Commerce使用[獨白](https://github.com/Seldaek/monolog)。 在Commerce應用程式`Psr\Log\LoggerInterface`[`di.xml`中實作為](https://github.com/magento/magento2/blob/2.4/app/etc/di.xml#L9)偏好設定的獨白。
