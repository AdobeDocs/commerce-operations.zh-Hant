...
1. 使用Commerce中繼資料建立撰寫器專案。
   ...
   **Adobe Commerce**
   ...
   >[!NOTE]
   >
   > 如果您使用以Commerce驗證金鑰設定的Composer `[auth.json](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/authentication-keys)`檔案或環境變數，則系統不會提示您輸入驗證金鑰。
