...
>[!INFO]
>
>**[!UICONTROL Developer]**&#x200B;索引標籤和選項只能在[開發人員模式](../configuration/cli/set-mode.md)中使用。 雲端基礎結構](https://devdocs.magento.com/cloud/requirements/cloud-requirements.html#cloud-req-test)上的[Adobe [!DNL Commerce] 不支援`Developer`模式。
...
具有大量[客戶區段](https://docs.magento.com/user-guide/marketing/customer-segments.html)的商家，可能會因為客戶動作（例如客戶登入以及將產品加入購物車）而發生效能大幅降低的情況。
