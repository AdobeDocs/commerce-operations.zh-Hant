...
使用命令列介面來啟用這些功能，或根據`app/etc/env.php`模組參考指南&#x200B;[__&#x200B;中定義的對應README檔案來編輯](https://developer.adobe.com/commerce/php/module-reference/)檔案。
...
請參閱[模組參考指南](https://developer.adobe.com/commerce/php/module-reference/module-async-order/)中的&#x200B;_非同步訂單_。
...
遞延總計計算預設為&#x200B;**停用**。 使用命令列介面來啟用這些功能，或根據`app/etc/env.php`模組參考指南&#x200B;[__&#x200B;中定義的對應README檔案來編輯](https://developer.adobe.com/commerce/php/module-reference/)檔案。
...
請參閱[模組參考指南](https://developer.adobe.com/commerce/php/module-reference/module-deferred-total-calculating/)中的&#x200B;_DeferredTotalCalculating_。
