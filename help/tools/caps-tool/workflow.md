---
title: '[!DNL Cloud Automation Patching Service (CAPS)]工作流程總覽'
...
# [!DNL Cloud Automation Patching Service (CAPS)]工作流程總覽
...
>[!NOTE]
>
>如果您的專案使用外部GitHub存放庫，[!DNL CAPS]會使用[[!DNL CAPS] GitHub應用程式](github-integration.md)自動處理驗證。 不需要其他認證。
