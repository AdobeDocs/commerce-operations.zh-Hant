...
* **ACSD-65100** (適用於Adobe Commerce和Magento Open Source >=2.4.4 &lt;2.4.8) — 修正在[!UICONTROL Media Gallery Image Optimization]設定中移除[!UICONTROL Maximum Width]和[!UICONTROL Maximum Height]的值會在影像最佳化程式期間導致錯誤的問題。
