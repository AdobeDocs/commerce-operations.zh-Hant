...
MDVA-42855修補程式修正結帳時新客戶地址未儲存至通訊錄的問題。 安裝[品質修補工具(QPT)](https://experienceleague.adobe.com/zh-hant/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.12時，即可使用此修補程式。 修補程式ID為MDVA-42855。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
