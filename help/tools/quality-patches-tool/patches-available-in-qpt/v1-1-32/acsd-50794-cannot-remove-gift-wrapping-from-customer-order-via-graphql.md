...
ACSD-50794修補程式修正使用者無法透過GraphQL從客戶訂單中移除贈品包裝的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.32時，即可使用此修補程式。 修補程式ID為ACSD-50794。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
...
1. 從前端建立客戶。
1. 建立簡單的產品。
1. 前往&#x200B;*[!UICONTROL Gift Messages]* > **[!UICONTROL Stores]** > **[!UICONTROL Configuration]** > **[!UICONTROL Sales]**&#x200B;並設定&#x200B;**[!UICONTROL Gift Options]** = *[!UICONTROL Allow Gift Messages]*&#x200B;來啟用&#x200B;*[!UICONTROL Yes]*。
1. 前往「*[!UICONTROL Gift Wrapping]*」>「**[!UICONTROL Stores]**」>「**[!UICONTROL Other Settings]**」建立&#x200B;**[!UICONTROL Gift Wrapping]**。
1. 取得客戶權杖。
