...
ACSD-46809修補程式修正了使用者指派大量產品來源時發生錯誤。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.21時，即可使用此修補程式。 修補程式ID為ACSD-46809。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
