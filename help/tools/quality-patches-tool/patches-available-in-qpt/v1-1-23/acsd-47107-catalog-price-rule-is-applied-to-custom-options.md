...
ACSD-47107修補程式修正目錄價格規則套用至自訂選項的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.23時，即可使用此修補程式。 修補程式ID為ACSD-47107。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
