...
description: MDVA-34948 Adobe Commerce修補程式修正網站速度變慢的問題。 安裝[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.1後，即可使用此修補程式。 修補程式ID為MDVA-34948。 請注意，Adobe Commerce 2.4.1版已修正問題。
