...
ACSD-58442修補程式修正Adobe Commerce將寬度768px的裝置視為行動裝置的問題，導致選單和標題載入行動檢視而非桌上型電腦。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50時，即可使用此修補程式。 修補程式ID為ACSD-58442。 請注意，此問題已排程在Adobe Commerce 2.4.8中修正。
