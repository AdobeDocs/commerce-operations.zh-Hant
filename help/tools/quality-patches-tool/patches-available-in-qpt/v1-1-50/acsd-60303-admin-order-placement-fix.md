...
ACSD-60303修補程式修正啟用HTML縮制後，無法向管理員下達訂單的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50時，即可使用此修補程式。 修補程式ID為ACSD-60303。 請注意，此問題已排程在2.4.8中修正。
