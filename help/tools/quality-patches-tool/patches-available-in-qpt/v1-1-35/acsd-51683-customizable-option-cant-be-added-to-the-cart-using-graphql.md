...
ACSD-51683修補程式修正無法使用GraphQL將可自訂選項新增到購物車的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.35時，即可使用此修補程式。 修補程式ID為ACSD-51683。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
