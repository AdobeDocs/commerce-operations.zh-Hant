...
ACSD-49748修補程式修正使用者無法傳送電子郵件邀請的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.29時，即可使用此修補程式。 修補程式ID為ACSD-49748。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
