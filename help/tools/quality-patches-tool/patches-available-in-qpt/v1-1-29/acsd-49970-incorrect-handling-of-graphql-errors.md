...
無論`GraphQLOperationNames`是否包含這個金鑰，`logDataHelper`金鑰處理不正確。

<u>要再現的步驟</u>：

1. 執行`bin/magento deploy:mode:set developer`。
1. 登入管理員。
1. 從&#x200B;**[!UICONTROL New Relic Integration]** > **[!UICONTROL Stores]** > **[!UICONTROL Configuration]** > **[!UICONTROL General]**&#x200B;啟用&#x200B;**[!UICONTROL New Relic Reporting]**
（注意：即使顯示錯誤指出[!DNL New Relic]擴充功能無法使用，也會儲存設定）。
1. 從&#x200B;*使用者端或任何其他使用者端或透過cURL執行此* GraphQL`http://yourMagentoDomain/graphql`突變至&#x200B;*[!DNL Altair]*。
