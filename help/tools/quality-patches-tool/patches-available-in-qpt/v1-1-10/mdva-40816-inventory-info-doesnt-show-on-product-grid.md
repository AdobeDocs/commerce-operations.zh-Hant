...
如果產品SKU包含特殊字元，MDVA-40816修補程式可解決產品格線中未顯示存貨資訊的問題。 安裝[品質修補工具(QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.10時，即可使用此修補程式。 修補程式ID為MDVA-40816。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
