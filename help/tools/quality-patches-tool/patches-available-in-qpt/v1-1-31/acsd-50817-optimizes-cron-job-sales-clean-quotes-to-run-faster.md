...
ACSD-50817修補程式會透過在引號表格中的`sales_clean_quotes`和`store_id`欄上新增複合索引，最佳化cron工作`updated_at`的執行速度。 安裝[!DNL Quality Patches Tool (QPT)] 1.1.31時，即可使用此修補程式。 修補程式ID為ACSD-50817。
