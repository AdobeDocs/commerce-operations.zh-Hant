...
ASCD-55334修補程式修正了GraphQL回應中未透過翻譯字典翻譯標籤的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.43時，即可使用此修補程式。 修補程式ID為ASCD-55334。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
