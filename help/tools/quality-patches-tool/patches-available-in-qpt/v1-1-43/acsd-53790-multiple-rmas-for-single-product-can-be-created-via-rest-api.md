...
ACSD-53790修補程式修正了可透過&#x200B;*Rest API*&#x200B;為單一產品建立多個RMA的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.43時，即可使用此修補程式。 修補程式ID為ACSD-53790。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
