...
ACSD-54890修補程式修正`aggregate_sales_report_bestsellers_data`造成[!DNL MySQL]錯誤（因為`/tmpdisk`空間不足）的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42時，即可使用此修補程式。 修補程式ID為ACSD-54890。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
...
* [在Commerce實作行動手冊中修改資料庫表格的最佳實務](/help/implementation-playbook/best-practices/development/modifying-core-and-third-party-tables.md#why-adobe-recommends-avoiding-modifications)
