...
description: 套用ACSD-64111修補程式以修正Adobe Commerce的問題，也就是在Page Builder中將條件組合新增至產品Widget條件會擲回InvalidArgumentException，因為vendor/magento/module-rule/Model/ConditionFactory.php中不存在類別。
