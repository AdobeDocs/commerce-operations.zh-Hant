...
1. 使用以下查詢來擷取客戶的所有[!UICONTROL Requisition Lists]。 使用值為&#x200B;**的** Authorization`Bearer <customer_token>`標頭。 如需詳細資訊，請參閱開發人員檔案中的[客戶查詢](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/customer/)文章。
...
如需[!DNL QPT]中其他可用修補程式的詳細資訊，請參閱[[!DNL Quality Patches Tool]指南中的](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html?lang=zh-Hant)：搜尋修補程式[!DNL Quality Patches Tool]。
