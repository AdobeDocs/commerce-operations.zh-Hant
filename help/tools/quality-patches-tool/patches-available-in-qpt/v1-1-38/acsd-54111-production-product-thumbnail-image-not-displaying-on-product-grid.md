...
ACSD-54111修補程式修正所有影像被預設產品預留位置影像取代的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.38時，即可使用此修補程式。 修補程式ID為ACSD-54111。 請注意，問題已在Adobe Commerce 2.4.6中修正。
