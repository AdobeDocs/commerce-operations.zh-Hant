...
ACSD-51240修補程式修正透過公司登錄檔單註冊時上傳的檔案遺失的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.33時，即可使用此修補程式。 修補程式ID為ACSD-51240。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
