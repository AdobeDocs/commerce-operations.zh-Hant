...
MDVA-43451修補程式可解決使用者無法設定共用目錄之定價與結構的問題。 安裝[品質修補工具(QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.13時，即可使用此修補程式。 修補程式ID為MDVA-43451。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
