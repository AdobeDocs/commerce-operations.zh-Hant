...
description: 套用ACP2E-3977修補程式以修正Adobe Commerce問題，其中設定**[!UICONTROL Rewards Points Balance Redemption Threshold]**欄位時，**[!UICONTROL Cap Reward Points Balance At]**欄位無法留空，導致驗證錯誤。
...
*上限獎勵點數餘額無效。 餘額必須為正數或留空。 驗證並再試一次。* 顯示錯誤。
