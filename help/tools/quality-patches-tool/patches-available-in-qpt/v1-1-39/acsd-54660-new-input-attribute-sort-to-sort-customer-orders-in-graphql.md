...
ACSD-54660修補程式修正新輸入屬性`sort`的問題，以依照`sort_field`和`sort_direction`在[!DNL GraphQL]中排序客戶訂單。 安裝[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.39時，即可使用此修補程式。 修補程式ID為ACSD-54660。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
