...
1. **[ACP2E-4513](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4513.md)**：修正系統未刪除過期驗證碼影像的問題。
...
1. **[ACP2E-4522](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4522.md)**：修正同時執行多個購物車合併或報價儲存請求時，`quote_coupons`資料表上發生間歇性重複金鑰錯誤的問題。
1. **[ACP2E-4528](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4528.md)**：修正客戶地址中的城市驗證問題，該問題現在允許正斜線(/)字元，並拒絕無效字元，例如！、&#39;、#和？。
...
1. **[ACP2E-4628](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4628.md)**：修正當「帳戶共用」設定為「全域」時，匯入具有大寫電子郵件地址的客戶會導致未定義陣列金鑰錯誤的問題。
1. **[ACP2E-4763](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4763.md)**：修正當目錄價格設定為「包含稅捐」時，GraphQL customerOrders查詢傳回膨脹`original_price_including_tax`與`original_row_total_including_tax`值的問題，因為套用兩次稅捐。
1. **[ACP2E-4732](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4732.md)**：修正當changelog表格中的`version_id`欄達到最大值時，具有大量更新的客戶停止部分索引的問題。
...
1. **[ACSD-60989](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acsd-60989.md)**：修正透過宣告式結構描述以外部索引鍵修改資料行而導致MariaDB發生錯誤的問題。
