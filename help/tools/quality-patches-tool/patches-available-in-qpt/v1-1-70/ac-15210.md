...
套用修補程式後，請更新Commerce USPS Shipping Carrier設定，以與新的USPS API整合。 如需指示，請參閱&#x200B;*存放和購買體驗指南*&#x200B;中的[USPS網頁工具淘汰](https://experienceleague.adobe.com/zh-hant/docs/commerce-admin/stores-sales/delivery/shipping-carriers/carriers#usps-web-tools-api-deprecation)主題。
