...
1. 前往&#x200B;**[!UICONTROL Stores]** > **[!UICONTROL Tax Zones and Rates]** > **[!UICONTROL Add new Tax Rate]**。
   ...
   1. 在&#x200B;**[!UICONTROL Rate Percent]**&#x200B;欄位中輸入&#x200B;*20.000000*。
...
1. 前往&#x200B;**[!UICONTROL Catalog]** > **[!UICONTROL Products]** > **[!UICONTROL Add Product]**。
   1. 在&#x200B;**[!UICONTROL Product Name]**&#x200B;欄位中輸入&#x200B;*test*。
   1. 在&#x200B;**[!UICONTROL SKU]**&#x200B;欄位中輸入&#x200B;*test*。
   1. 在&#x200B;**[!UICONTROL Price]**&#x200B;欄位中輸入&#x200B;**82.65**。
   1. 將&#x200B;**[!UICONTROL Tax Class]**&#x200B;設定為&#x200B;*應稅貨品*。
   1. 在&#x200B;**[!UICONTROL Quantity]**&#x200B;欄位中輸入&#x200B;*100*。
   1. 按一下&#x200B;**[!UICONTROL Save]**。
1. 將範圍變更為&#x200B;*預設存放區檢視*。
...
1. 前往「**[!UICONTROL Marketing]** > *[!UICONTROL Promotions]* > **[!UICONTROL Catalog Price Rule]** > **[!UICONTROL Add New Rule]**」。
   ...
   1. 在&#x200B;**[!UICONTROL Discount Amount]**&#x200B;欄位中輸入&#x200B;*20.000000*。
   1. 按一下&#x200B;**[!UICONTROL Save]**。
1. 執行完整重新索引：
...
1. 透過&#x200B;**[!UICONTROL Store]**&#x200B;執行下列[!DNL GraphQL]查詢： *預設*&#x200B;設定於標頭中：
