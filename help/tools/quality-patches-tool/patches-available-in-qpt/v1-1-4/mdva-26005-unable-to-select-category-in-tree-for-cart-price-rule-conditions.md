...
MDVA-26005修補程式解決使用者無法在購物車價格規則條件的類別樹狀結構中選取類別的問題。 安裝[品質修補工具(QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.4時，即可使用此修補程式。 修補程式ID為MDVA-26005。 請注意，問題已在Adobe Commerce 2.3.6中修正。
