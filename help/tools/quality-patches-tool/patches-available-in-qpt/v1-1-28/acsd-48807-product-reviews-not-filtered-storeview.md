...
ACSD-48807修補程式修正了storeview無法透過GraphQL篩選產品評論的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.28時，即可使用此修補程式。 修補程式ID為ACSD-48807。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
