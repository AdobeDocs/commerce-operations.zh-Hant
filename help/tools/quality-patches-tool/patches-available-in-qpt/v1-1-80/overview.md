...
1. **[ACP2E-4610](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4610.md)**：修正`sales_clean_quotes` cron工作發生效能問題的問題。
1. **[ACP2E-4552](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4552.md)**：修正GraphQL回應中未傳回公司狀態的問題。
1. **[ACP2E-4496](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4496.md)**：修正Analytics cron工作在執行期間導致效能降低，進而改善整體系統效能的問題。
...
1. **[ACP2E-4615](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4615.md)**：修正線上訂單退款失敗並出現PayPal錯誤的問題，指出&#x200B;*PayPal閘道拒絕要求。 內部錯誤。*。
1. **[ACP2E-4626](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4626.md)**：修正部分Storefront JavaScript檔案被要求並執行兩次，而造成間歇性重複載入和不穩定行為的問題。
...
1. **[ACP2E-4813](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4813.md)**：修正某些產品在結帳時無法使用USPS送貨方法，且送貨預估不正確的問題，包括分割成多個套件的訂單。
1. **ACP2E-4626**：修正部分Storefront JavaScript檔案被要求並執行兩次，而造成間歇性重複載入和不穩定行為的問題。
1. **[ACP2E-4653](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4653.md)**：修正透過[!DNL REST] API擷取或更新規則時，**[!UICONTROL Category (Parent Only)]**&#x200B;和&#x200B;**[!UICONTROL Category (Children Only)]**&#x200B;的購物車價格規則條件屬性範圍未公開的問題。
...
1. **[ACSD-53502](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acsd-53502.md)**：修正在iOS [!DNL Safari]中，由於遞回呼叫New Relic監視指令碼而導致&#x200B;**[!UICONTROL Add to Cart]**&#x200B;在店面間歇性失敗而導致頁面重新載入的問題。
