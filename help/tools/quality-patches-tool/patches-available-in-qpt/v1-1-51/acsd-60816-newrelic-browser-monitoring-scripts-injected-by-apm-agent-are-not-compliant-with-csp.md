...
ACSD-60816修補程式修正了APM代理程式插入的[!DNL New Relic]瀏覽器監視指令碼不符合內容安全性原則(CSP)的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51時，即可使用此修補程式。 修補程式ID為ACSD-60816。 請注意，此問題已排程在Adobe Commerce 2.4.8中修正。
