...
ACSD-59786修補程式修正擷取過期報價的`quote_id`時GraphQL查詢傳回錯誤的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51時，即可使用此修補程式。 修補程式ID為ACSD-59786。 請注意，此問題已排程在Adobe Commerce 2.4.8中修正。
