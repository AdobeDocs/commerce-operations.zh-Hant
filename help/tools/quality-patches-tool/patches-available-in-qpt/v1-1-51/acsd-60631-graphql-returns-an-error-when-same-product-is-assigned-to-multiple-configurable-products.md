...
ACSD-60631修補程式修正將相同產品指派給多個可設定產品時，GraphQL查詢傳回錯誤的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51時，即可使用此修補程式。 修補程式ID為ACSD-60631。 請注意，此問題已排程在Adobe Commerce 2.4.8中修正。
