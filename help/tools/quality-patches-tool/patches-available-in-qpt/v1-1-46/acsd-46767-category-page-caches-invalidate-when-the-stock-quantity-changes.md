...
ACSD-46767修補程式修正庫存數量變更時（即使產品仍有庫存），[!UICONTROL Category]頁面快取無效的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.46時，即可使用此修補程式。 修補程式ID為ACSD-46767。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
