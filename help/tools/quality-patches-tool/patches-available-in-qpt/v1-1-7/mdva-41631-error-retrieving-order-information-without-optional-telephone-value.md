...
MDVA-41631修補程式修正使用者透過[!DNL GraphQL]擷取訂單資訊時，若無選擇性「電話」值，會發生錯誤的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.7時，即可使用此修補程式。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
