...
MDVA-36309修補程式可解決管理格線中依屬性搜尋產品速度緩慢的問題。 安裝[品質修補工具(QPT)](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.3時，即可使用此修補程式。 修補程式ID為MDVA-36309。 請注意，問題已在Adobe Commerce 2.4.3中修正。
