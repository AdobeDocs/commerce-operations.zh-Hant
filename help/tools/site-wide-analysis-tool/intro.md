...
此外也包含歷史圖表，以追蹤網站健康情況在一段時間內的變化。
   - 顯示提供下列資源連結的&#x200B;**[!UICONTROL Security Center Widget]**：
      - [符合 [!DNL end of life (EOL)]的技術 [!DNL Stack] 版本規範](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements)
      ...
      - [[!DNL Site-Wide Analysis Tool]最佳作法安全性建議](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/site-wide-analysis-tool/recommendations)
