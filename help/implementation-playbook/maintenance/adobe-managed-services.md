...
- Adobe Commerce **增強的服務等級協定(SLA)**—99.9%的應用程式等級，一般雲端基礎結構客戶在99.99%的基礎結構等級之上即可達到。
...
<tbody>
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td>擁有者<br />CSE協調基礎建設服務升級。<br />CSE排程會議會議事件以進行升級。<br />CSE協助將資料從生產環境移轉至中繼環境。</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>投稿人</td>
    <td>所有者</td>
    <td>參與者<br />CSE透過監控應用程式和基礎結構的效能來協助負載測試。<br />CSE協助設定Commerce安全性掃描工具。</td>
  </tr>
  <tr>
    <td>中繼的使用者驗收測試</td>
    <td>所有者</td>
