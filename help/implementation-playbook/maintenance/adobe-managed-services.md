...
- **增強的服務等級協定(SLA)**—99.9%的應用程式等級，一般雲端基礎結構客戶在99.99%的基礎結構等級之上即可達到。
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Adobe Commerce Source程式碼存取</td>
            <td></td>
            <td></td>
            <td>所有者</td>
        </tr>
...
Amazon Web Services和Microsoft Azure等平台合作夥伴會在套用平台自訂功能時，確保最高的安全性涵蓋範圍，而Adobe的Managed Services團隊會提供核心安全性服務，例如法規遵循、記錄、驗證、掃描和監控，以及伺服器安全性和安全應用程式設定。 如需詳細資訊，請參閱[Adobe Commerce安全性](https://business.adobe.com/tw/products/magento/secure-ecommerce.html)。
...
Managed Services團隊在協助規劃及協助升級程式方面扮演積極角色。 您的客戶成功工程師(CSE)與您的升級專案團隊合作，包括專案經理和開發人員（內部主題專家、Adobe認證合作夥伴或Adobe Consulting的專業人員），以協助您的團隊在升級期間確保正確規劃並遵守最佳實務。
...
<tbody>
  <tr>
    ...
    <td>所有者</td>
    <td>投稿人</td>
    <td>參與者<br />CSE提供升級範本和升級計畫範例；提供建議和最佳實務提示。</td>
  </tr>
  <tr>
    <td>決定所需的基礎架構變更</td>
    <td></td>
    <td>投稿人</td>
    <td>擁有者<br />CSE會檢閱測試和生產基礎結構，以確保適當的規模。</td>
  </tr>
  <tr>
    <td>評估升級複雜性<br />識別並記錄套件、問題與修正，以及第三方與自訂模組</td>
    <td>投稿人</td>
    <td>所有者</td>
    <td>參與者<br />CSE提供升級相容性工具的報告與建議。</td>
  </tr>
  <tr>
    ...
    <td></td>
    <td></td>
    <td>擁有者<br />CSE會協調基礎建設服務升級。<br />CSE會排程會議事件以進行升級。<br />CSE會協助將資料從生產環境移轉至中繼環境。</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td></td>
    <td>所有者</td>
    <td>參與者<br />CSE會執行升級後的Runbook，以偵測及修正與升級相關的問題。</td>
  </tr>
  <tr>
    ...
    <td>投稿人</td>
    <td>所有者</td>
    <td>參與者<br />CSE透過監視應用程式和基礎結構的效能來協助負載測試。<br />CSE協助設定Commerce安全性掃描工具。</td>
  </tr>
  <tr>
    <td>中繼的使用者驗收測試</td>
    <td>所有者</td>
    <td>投稿人</td>
    <td>參與者<br />CSE會驗證升級後應用程式和基礎結構是否正確執行。</td>
  </tr>
  <tr>
    <td>啟動至生產環境</td>
    <td>投稿人</td>
  ...
  <tr>
    ...
    <td>投稿人</td>
    <td>投稿人</td>
    <td>擁有者<br />CSE監視應用程式和基礎結構的效能。</td>
  </tr>
</tbody>
</table>
