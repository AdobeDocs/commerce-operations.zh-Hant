...
#### 屬性集資訊會快取（EAV快取），但在管理區域中更新屬性集後就不會清除

解決啟用EAV快取（快取失效/API匯入行為）時，將新屬性新增至屬性集後遺失的產品屬性值的問題。

_AC-12321 - [GitHub問題](https://github.com/magento/magento2/issues/38827) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/38864)_
...
修正在graphql要求回應中，只取得未針對產品停用的媒體集影像的問題。

_AC-1608 - [GitHub問題](https://github.com/magento/magento2/issues/34342) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/34897)_
...
先前，傳送格式錯誤的請求本文或引數至各種REST API端點（例如/V1/carts/search、/V1/orders、/V1/products等） 導致一般的「內部伺服器錯誤」(500)，導致難以診斷輸入問題。
...
透過封鎖重新連線通道上的無效確認/拒絕嘗試，改善AMQP消費者復原能力。

_ACP2E-4621 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
#### 沒有允許的字元時，客戶地址電話驗證無法運作

系統傳回錯誤訊息，指出電話無效。

_AC-16227 - [GitHub問題](https://github.com/magento/magento2/issues/40361) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40416)_

#### 網站和商店物件會以字串形式傳回id

修正網站及商店ID以字串而非整數傳回的問題。 這會解決嚴格模式中的型別錯誤，允許EmailNotification：：newAccount()和類似方法正常運作。

_AC-16486 - [GitHub問題](https://github.com/magento/magento2/issues/40469)_

#### 客戶城市驗證無法用於不允許的字元

修正客戶地址可能以無效字元（例如/、@、#、！）儲存的問題 在城市欄位中。 進行此修正後，系統會正確驗證並拒絕包含不允許字元的地址。

_AC-16504 - [GitHub問題](https://github.com/magento/magento2/issues/40521) - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/57bad413)_

#### [問題]修正：增加admin_user_session中IPv6支援的IP欄長度

目前，admin_user_session中的ip欄限製為15個字元，不足以用於IPv6位址（最多45個字元）。 此PR會將長度增加到45，以確保與IPv6完全相容，並防止在使用IPv6時截斷資料或發生錯誤。

_AC-16659 - [GitHub問題](https://github.com/magento/magento2/issues/40570) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40563)_
...
在客戶地址中輸入城市時，驗證現在允許正斜線並正確拒絕無效字元，例如！、&quot;、#和？。

_ACP2E-4527 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_

#### 地址驗證程式在升級至2.4.8-p3後中斷現有客戶

之前，在本次修正前，使用字元的現代電話號碼。 或\未正確驗證。 套用此修正後，帶有字元的現代電話號碼。 或\現已驗證。

_ACP2E-4554 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### 在密碼重設要求及目前購物車清除後，[雲端] PHPSESSID已變更

在修正之前，提交忘記密碼表單會導致工作階段被銷毀/重新產生（PHPSESSID已變更），而且訪客購物車已被清除。 修正後，提交忘記密碼表單會使工作階段保持不變，並保留訪客購物車。

_ACP2E-4524 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [問題] Fix(admin)： modal-slide內的日期選擇器位置正確

此提取請求修正Magento日期選擇器未在管理模組對話方塊中正確顯示的問題。
例如，從管理面板編輯或建立產品時，這會影響進階定價區段。

_AC-16378 - [GitHub問題](https://github.com/magento/magento2/issues/40468) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40225)_

#### 對於相同設定，購物車頁面和產品頁面中的FPT值不同

修正因四捨五入不一致，產品頁面和購物車頁面上「固定產品稅」 (FPT)值顯示不同的問題。 進行此修正後，目錄、產品和購物車頁面中的FPT價格現在一致，消除了不相符。

_AC-16550 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/8391dbcc)_
...
游標停留顏色現在會如預期套用至管理靜態格線的列。[GitHub-35358](https://github.com/magento/magento2/issues/35358)
...
先前，當Redis無法使用時，本機快取、過時快取和Redis可能會變得不同步。 在Redis中斷期間所做的設定變更，在Redis復原後未正確反映，導致舊值持續存在。 此修正可確保跨所有快取之間的正確同步，以便即使當Redis停用時，最新儲存的值也能保留並顯示。

_ACP2E-4447 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

#### 啟用非同步網格索引時，封存網格未與最新訂單資料同步

銷售訂單封存格線現在會以非同步索引顯示正確的訂單狀態

_ACP2E-4493 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_

#### 產品屬性大量更新變更產品型別虛擬 — >簡單

防止「這是否有權重？」 在插入大量更新屬性面板之前啟動控制項，避免虛擬產品意外地變更重量。

_ACP2E-4500 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

#### 當產品名稱和自訂選項較長時，多頁發票PDF中的重疊文字

修正前，在多頁的「發票」、「出貨」、「銷退折讓單」及「退貨」PDF中，具有自訂選項的長產品名稱可能會在分頁後與相鄰的欄/專案重疊，導致行專案區段無法讀取。
修正後，明細專案現在可以跨頁面正確流動，而長名稱/選項在「商業發票」、「出貨」、「銷退折讓單」及「退貨」PDF中不會重疊。

_ACP2E-4630 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/d8a248cd)_

#### 升級後[雲端]大型RTE編輯器封鎖表情符號

在修正之前，WYSIWYG/PageBuilder驗證會無條件封鎖最新的4位元組emoji內容，因為套用過廣的UI規則，即使實際儲存路徑為utf8mb4安全的安裝亦然。 修正後，透過檢查使用中DB連線字元集/定序與目標內容欄定序，根據真正的持續性路徑來決定驗證，因此utf8mb4-safe內容是允許的，而utf8/utf8mb3路徑仍受到保護。

_ACP2E-4675 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0) - [GitHub程式碼貢獻](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_

#### [雲端]影像路徑在Pagebuilder中第二次編輯時為絕對路徑

修正頁面產生器文字內嵌編輯可在再次編輯影像後儲存絕對媒體影像URL，而非保留可攜式`{{media url=...}}`指示詞的問題。

_ACP2E-4698 - [GitHub程式碼貢獻](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
將目錄樹狀結構載入變更為隨選節點擴充，而非預先建置完整的樹狀結構，大幅縮短大型媒體目錄結構的初始入門回應時間，藉此提升媒體館效能

_ACP2E-4605 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
#### 在客戶的新增和編輯頁面中，「與公司關聯」欄位的UI表單重設按鈕未按預期運作

修正重設按鈕未正確重設客戶新增/編輯表單中「與公司關聯」欄位的問題。 表單現在會正確重設所有欄位，而不會重新載入頁面，這會還原預期行為。
...
修正前，佇列產品匯出檔案會直接寫入其最終的var/export位置，因此「管理員匯出」格線可以顯示這些檔案，並允許在產生完成之前下載。 因此，使用者可以下載空白或部分產生的CSV檔案，而變數/匯出中存在的無關檔案也可能出現在匯出清單中且可下載。
修正後，排入佇列的匯出會寫入暫存檔案，並在成功完成產生後才發佈至最終匯出位置。 現在，管理員匯出格線和下載動作只會公開格式符合已設定的「匯出檔案格式」選項的已完成匯出檔案，以防止部分下載，以及從UI中排除不相關的檔案。

_ACP2E-4724 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_
...
線上訂單退款目前運作正常。 之前，它會擲回此錯誤：「PayPal閘道拒絕要求。 內部錯誤」。

_ACP2E-4615 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_

### 管理員UI、效能

#### 儲存產品時中繼管理面板速度嚴重緩慢

管理產品表單儲存/編輯大型屬性集的速度更快，只需減少昂貴的使用者端驗證過程，同時保留現有的驗證行為。 這麼做可降低Admin UI中「頁面無回應」停滯的可能性。

_ACP2E-4488 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_

### 管理員UI、產品

#### [Cloud] RequireJS mixins.js導致所有dep模組載入重複的指令碼。

在修正之前，部分店面JavaScript檔案可能會被請求並執行兩次，導致間歇性的重複載入和不穩定的行為。 修正後，JavaScript相依性只會載入一次，消除重複請求，同時保持現有mixin功能不變。

_ACP2E-4626 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
在Admin中建立或編輯禮卡帳戶時，「到期日」欄位現在已可正確驗證。 先前，在儲存帳戶時，手動輸入的不符合有效日期格式的值可能會遭到錯誤處理。
...
#### [問題] analytics_collect_data cron工作長期執行的效能修正

透過更新報告驗證查詢以使用LIMIT 1而不是LIMIT 0，最佳化大型資料庫的analytics_collect_data cron作業效能。 這樣可避免在驗證期間載入不必要的完整表格資料，並大幅縮短執行時間。 無功能影響，完全回溯相容的改進。

_AC-16639 - [GitHub問題](https://github.com/magento/magento2/issues/40590) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40463)_
...
#### 由於aggregate_sales_report_order_data Cron工作，服務節點上最大磁碟I/O尖峰

修正每日彙總訂單報表耗費太多時間產生大量訂單，導致磁碟I/O尖峰及效能降低的問題。 修正後，會及時產生報表。

_ACP2E-4363 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

#### [雲端]效能因analytics_collect_data cron執行而降低

改善與Analytics Cron工作相關的效能。

_ACP2E-4496 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### 前往結帳，並在登入時將客戶指派給公司後，要求報價在購物車上不可見

修正當客戶在店面登入時被指派給公司時，「前往結帳」和「請求報價」按鈕在購物車頁面上不顯示的問題。 進行此修正後，兩個按鈕會立即顯示，不需要客戶登出並重新登入。
...
#### [B2B]當部分引號包含已刪除的產品時，我的引號頁面不會顯示任何引號

現在當某些引號包含已刪除的產品時，我的引號會正確顯示出來。

_ACP2E-4608 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Google Pay的多重優惠券無法如預期運作

修正Google支付快速薪資表中多個抵用券代碼無法如預期運作的問題。 以前，套用第二個抵用券代碼會錯誤地移除第一個抵用券的折扣，並顯示不準確的總計。 移除抵用券也無法正確更新薪資表。
客戶現在可以在Google支付快速付薪表中套用多個優惠券代碼，而且所有折扣都會準確反映。

_BUNDLE-3507_

#### Braintree SDK會在每個頁面上呼叫以取得使用者端Token，即使「稍後付款」訊息停用亦然

Braintree SDK會進行呼叫，以便在每次載入頁面時擷取使用者端Token，即使「稍後付款」訊息停用亦然。 這會導致不必要的請求和潛在的效能問題。
現在，只有在購物車的PayPal付款方式和「稍後付款」訊息皆已啟用時，系統才會要求Braintree使用者端權杖。 這可防止不必要的Token要求，並改善頁面載入效能。

_BUNDLE-3508_

#### 停止在客戶帳戶區域的「儲存的付款方法」區段中呈現Braintree付款方法的存放範本和js檔案

Braintree付款方法的JavaScript和範本檔案會在客戶帳戶區域的「儲存的付款方法」區段中呈現，即使Braintree付款方法和儲存庫設定已停用。 這會在瀏覽器主控台中造成不必要的錯誤。
系統現在會先檢查Braintree付款方式及其存放庫組態是否已啟用，然後再轉譯相關檔案和表單。 只有當兩者都啟用時，存放範本和指令碼才會出現在「已儲存的付款方法」區段中。

_BUNDLE-3509_

#### Apple Pay和Google Pay協力廠商相容性問題

客戶嘗試使用協力廠商簽出擴充功能（例如Hyva Checkout）或自訂透過Apple Pay或Google Pay付款時遇到錯誤。 具體來說，Apple Pay會因為遺失商家名稱而擲回TypeError，而Google Pay也可能根據自訂程式碼互動而失敗。
Apple Pay和Google Pay的相容性問題已解決。 系統現在會正確處理協力廠商簽出擴充功能和自訂，確保必要的設定值存在且正確傳回。

_BUNDLE-3510_

#### 透過Braintree的Google Pay會在結帳期間導致無限載入

透過Braintree啟用Google Pay時，選取Google Pay作為付款方式後，結帳程式會進入無限載入狀態。 這會導致客戶無法完成訂單，且不會提供錯誤訊息或回饋意見。
已修正透過Braintree的Google Pay整合，以確保付款流程如預期般進行。 客戶現在可以在結帳時選取Google Pay、完成付款程式，並成功下訂單。
...
#### 使用多個地址簽出並新增與可設定產品不同的選項後，小計顯示0

修正在多地址結帳後，可設定產品新增不同選項後，購物車小計錯誤顯示為0的問題。 小計現在可正確反映實際購物車值。

_AC-14460 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/57bad413)_
...
#### [問題]呼叫購物車上的RemoveItem而非ItemRepository

將CartItemRepository上的deleteById呼叫取代為購物車執行個體上的removeItem。
這可確保觸發預期的觀察者，並且實際更新cart物件上的專案，而不是僅在資料庫中更新。

_AC-15963 - [GitHub問題](https://github.com/magento/magento2/issues/40255) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40248)_
...
#### 購物車價格規則折扣無法使用排除sku條件

修正即使小計計算中存在排除的SKU，購物車價格規則仍錯誤套用的問題。 折扣邏輯現在會在評估規則條件時正確忽略已排除的專案。

_AC-16417 - [GitHub問題](https://github.com/magento/magento2/issues/40503) - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/8391dbcc)_
...
#### 使用Recaptcha v2套用禮品卡時出現[雲端]問題（「我不是機器人」）

現在，在成功進行reCAPTCHA驗證後，啟用reCAPTCHA v2 （「我不是自動機制」）時可正確套用禮品卡。

_ACP2E-4410_

#### 使用管理員的登入作為客戶時，正在建立Null報價

解決在「以客戶身分登入」流程期間建立Null報價的問題。

_ACP2E-4472 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

#### 搭售產品行為與固定運費及免運費不一致

在修正之前，若透過購物車折扣規則提供捆綁產品，則未正確計算捆綁產品的免運費。 修正後，已正確計算套件組合產品的免運費。

_ACP2E-4536 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_

#### 無法為具有數值SKU的產品下訂單

訂購具有數值SKU的產品時，系統不再擲回錯誤。

_ACP2E-4669 - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/83d11138)_

#### 客戶地址屬性(EAV)驗證規則與硬式編碼驗證規則衝突。

改善客戶地址電話驗證，支援最多255個字元的值，將伺服器端檢查與資料庫限制對齊。 錯誤處理也經過改良，讓超長的電話號碼傳回明確的長度特定訊息。

_ACP2E-4735 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### [優惠券]在quote_coupons資料表中發生間歇性重複優惠券輸入錯誤

解決當同時執行多個購物車合併或報價儲存請求時，quote_coupons表格上出現間歇性重複索引鍵錯誤的問題。
...
#### Magento\Store\Model\System\Store類別的[TOYOTA]效能問題

與多個商店和網站相關的效能改善。

_ACP2E-4491 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

### 購物車與結帳、定價、稅金

#### 在多貨幣設定中，搭售產品價格在PDP和購物車之間顯示不正確的稅金和貨幣值。

套件組合產品價格現在可在PDP和結帳頁面之間正確顯示。

_ACP2E-4673 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### Magento目錄產品清單Widget傳回不正確的計數

Adobe Commerce目錄產品清單Widget現在會傳回正確的總計數和分頁（例如依設定跨頁面9個專案）。

_AC-14541 - [GitHub問題](https://github.com/magento/magento2/issues/39863) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40421)_
...
產品中繼關鍵字自動產生現在會取代已設定遮罩中的所有預留位置（例如`{{name}}, order {{name}}`），而不僅僅是第一次出現。

_AC-14626 - [GitHub問題](https://github.com/magento/magento2/issues/35670) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40412)_
...
#### 當公司管理員變更時，不會將公司的客戶群組ID指派給公司管理員的客戶群組ID

變更B2B中公司的管理員時，新公司管理員的客戶群組ID未更新，以符合公司指派的共用目錄。 這會導致新管理員的層級價格和類別許可權是根據之前公司的客戶群組，導致不正確的定價和許可權。
現在，當管理員變更時，系統可正確更新公司管理員的客戶群組ID。 這可確保新管理員收到與其公司的共用目錄相關聯的正確層級價格和類別許可權。

_AC-14897 - [GitHub問題](https://github.com/magento/magento2/issues/39964)_
...
此修正包含集合SELECT子句中product_alert_stock和product_alert_price表格的website_id和store_id，以確保管理網格顯示訂閱每個警示的正確網站。

_AC-15044 - [GitHub問題](https://github.com/magento/magento2/issues/40027) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40431)_
...
#### [問題]瀏覽沒有專案的比較頁面時發生修正錯誤

修正造訪沒有比較專案的目錄產品比較頁面時，造成嚴重錯誤，確保比較動作安全地處理空白專案集合，而非擲回例外狀況。

_AC-15746 - [GitHub問題](https://github.com/magento/magento2/issues/40205) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40203)_
...
_AC-16380 - [GitHub問題](https://github.com/magento/inventory/issues/3384) - [GitHub程式碼貢獻](https://github.com/magento/inventory/pull/3385) - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/b4aeda50)_
...
修正建立產品屬性時，已刪除的下拉式清單選項仍會保留的問題。 系統現在會正確移除選取的選項，並在儲存後反映準確的計數。

_AC-16437 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/57bad413)_
...
修正之後，搭配`--skip_hidden_images`旗標使用的`catalog:images:resize`命令將不會針對沒有影像的網站產生影像快取。
...
在修正之前，您可以儲存具有循環相依性的類別。 修正後，系統會透過驗證規則防止此行為。

_ACP2E-4505 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_

#### 子頁面URL索引鍵變更時，CMS階層不會更新階層URL (2.4.8-p3)

修正變更CMS頁面的URL金鑰未更新頁面階層式URL的問題（例如，重新命名為my-account-2後，/help/my-account維持不變）。 階層更新邏輯現在正確包含頁面本身的節點，因此其request_url會更新，而新路徑（例如/help/my-account-2）會如運期般運作。

_ACP2E-4531_

#### 不同存放區的影像預留位置未如預期顯示

修正前的預留位置影像，在插入URL時沒有載入存放區程式碼中。 修正後，影像預留位置無論是否在URL中提供的存放區程式碼，都區分大小寫。

_ACP2E-4533 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/aa2e16d1)_

#### [CLOUD]資料表magento_catalogpermissions_index_product上的死結。 繼續

在修正前，執行目錄許可權產品重新索引可能會讓現有許可權索引列保持不變，因此更新的類別許可權授予無法可靠地反映在產品上。
修正後，重新索引可正確更新現有的許可權索引列，讓許可權變更能一致地套用至店面存取、價格可見性和結帳可用性。

_ACP2E-4603_

#### Target規則索引器cron不會挑選僅在存放區檢視範圍啟用的產品

修正前，目標規則索引器並未擷取未在管理範圍中啟用的產品。 現在，修正之後，如果產品至少在一個範圍中啟用，則會擷取產品。
...
#### [雲端] — 當attribute_type的catalog_product_entity_int值在graphql產品中選取0或Null時顯示錯誤

修正具有彙總的GraphQL產品查詢傳回屬性值或選項無效錯誤的問題。 查詢現在可以正確處理無效資料並傳回正確結果。

_ACP2E-4529 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### [小錯誤]當欄位值包含`\`時，無法點選管理面板`listing component`的篩選器
...
#### 類別影像名稱開頭為「 — 」（破折號）時，媒體集資料夾結構消失

沒有可用的說明。

_AC-16544 - [GitHub問題](https://github.com/magento/magento2/issues/40536)_

#### 儲存「目錄事件製表器」CMS區塊時顯示「CMS區塊包含無效內容」錯誤

修正儲存預設「目錄事件製表器」CMS區塊時顯示「CMS區塊包含無效內容」錯誤的問題。 進行此修正後，區塊可成功儲存，且不會在「管理」面板中發生任何錯誤。

_AC-16686 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### [ADOBE STOCK] 「無法擷取Adobe Stock搜尋檔案結果」上的重要記錄（即使整合已停用）。

Adobe Stock整合停用時，系統不再記錄錯誤「無法擷取Adobe Stock搜尋檔案結果」。

_ACP2E-4634_

#### 建立新頁面並使用頁面產生器時出現錯誤擲回錯誤

修正使用Page Builder時CMS頁面無法儲存的問題。
...
#### 客戶管理員上的`[Admin][Customer]`密碼重設失敗

修正從管理面板重設客戶密碼時導致系統錯誤和頁面當機的問題。 密碼重設現在可正確運作，且傳送重設連結時不會發生錯誤，即使在涉及商店變更的邊緣案例中亦然。

_AC-14940 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/3e41a43b)_
...
#### NewRelic模組 — 移除不需要的相依性

從magento/module-new-relic-reporting模組移除不必要的magento/magento-composer-installer相依性，以清理相依性中未使用/緊密的耦合

_AC-15945 - [GitHub問題](https://github.com/magento/magento2/issues/40243)_

#### [問題]防止含有`comment=""`的`db_schema.xml`宣告破壞零停機部署
...
#### [問題]從`Magento_Downloadable`移除禁止的`@author`標籤
...
#### [問題]從`Magento_Backup`和`Magento_Bundle`移除禁止的`@author`標籤
...
#### Magento 2.4.8更新後Cron captcha_delete_expired_images無法運作

修正前，系統不再自動刪除過期的驗證碼影像。 修正後，過期的驗證碼影像會由對應的cron工作刪除。

_ACP2E-4512 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

### 架構，效能

#### [CLOUD]在銷售網格非同步cron中緩慢MySQL調解查詢 — 已檢查完整資料表掃描，20+ s，~14M列

透過將遺失ID探索切換至具有游標型遞進的限制式entity_id視窗，減少大量存放區上重複的大型表格掃描，改善銷售網格非同步調解效能。

_ACP2E-4585 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/aa2e16d1)_
...
還原先前以不同格式傳回錯誤的變更。 現在系統會以一致的方式傳回潛在錯誤，而不會破壞GraphQL結構描述。
...
#### AC-2.4.9 — 無法在EDS樣版上搜尋訂單

guestOrder GraphQL查詢輸入型別已更新為GuestOrderInformationInput，而非OrderInformationInput。

_LYNX-872_

#### [AC-2.4.9]購物車查詢針對具有多Source庫存(MSI)且預設庫存為0的產品傳回不正確的可用性狀態

解決錯誤傳回的購物車API為is_available的問題：如果產品在多個Source詳細目錄(MSI)來源之間有足夠的詳細目錄，則為false。

_LYNX-918_

#### [AC-2.4.9]無法使用setNegotialQuoteShippingAddress/setNegotialQuoteBillingAddress GQL設定客戶的送貨/帳單地址

公開「客戶地址」GraphQL查詢中的uid欄位，以啟用可協商報價的送貨與帳單地址設定。

_LYNX-924_

#### [AC-2.4.9]訂單清單 |內部伺服器錯誤

針對遺失的已購產品傳回null值，避免訂單歷史記錄和最近訂單中的例外狀況，確保訂單流程的穩定性。

_LYNX-937_

#### [AC-2.4.9]將NegotialQuoteBillingAddressInput與BillingAddressInput對齊

&#39;
Aligned NegotialQuoteBillingAddressInput、BillingAddressInput、ShippingAddressInput和GiftRegistryShippingAddressInput在取代客戶地址ID時支援客戶地址uid。
推出deleteCustomerAddressV2和updateCustomerAddressV2變動，以支援客戶地址uid，並淘汰現有的deleteCustomerAddress和updateCustomerAddress變動。
...
#### [雲端] SalesGraphQl customerOrders查詢傳回不正確的訂單專案欄位值

修正當「型錄價格」設定為「包含稅捐」時，SalesGraphQl customerOrders查詢傳回膨脹的original_price_include_tax和original_row_total_include_tax值的問題，因為稅捐是第二次套用至已包含稅捐的價格。

_ACP2E-4762 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### 進階定價CSV，未匯出產品CSV。 OOM （含4G記憶體限制）

修正前，大型目錄上的記憶體使用量/OOM過高可能會導致「完整產品」和「進階定價」匯出失敗，而且處理期間動態頁面大小變更時，產品匯出分頁可能會產生重複資料列。 修正後，匯出作業會使用分頁批次處理完成並有穩定的記憶體行為，且會消除分頁重疊的重複列，而匯出的列內容會維持與基準輸出對齊。

_ACP2E-4587 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
現在，在取消訂單後，可正確計算套件組合產品銷售性。

_ACP2E-4481 - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/96b77663)_

#### Magento允許多位客戶同時下訂單時進行過度銷售

有了MSI，多位客戶可同時下相同產品的訂單，並超出可用庫存，導致超額銷售。 修正後，結帳同時執行時，每個產品只有一個訂單可以成功，因此不再發生過度銷售情形。

_ACP2E-4509 - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/a33c60f2)_

#### 如果使用者端在購物籃中有超過140篇文章，[雲端]逾時

詳細目錄資料庫查詢已經過最佳化，可在結帳期間快速載入詳細目錄資料。 如此一來，每個SKU就不需要個別查詢，大幅提升使用大型購物車的結帳效能。

_ACP2E-4519 - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/40858072)_

### 忠誠度

#### 當客戶沒有點數時，[CLOUD] getCustomerRewardPoints擲回例外狀況

客戶獎勵點數在透過管理員建立時已成功啟動。

_ACP2E-4403 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
#### 先呼叫Invoice getComments時，Invoice addComment可能會擲回錯誤

此PR解決在$invoice->addComment()之前呼叫$invoice->getComments()所導致的嚴重錯誤「呼叫陣列上的成員函式addItem()」。 此修正會在「發票」模型的註解方法中實作陣列與「收集」型態之間的正確型別檢查與轉換，確保這兩種方法可依任何順序呼叫，而不會發生錯誤，同時維持回溯相容性。

_AC-14848 - [GitHub問題](https://github.com/magento/magento2/issues/39884) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40428)_
...
#### 「銷售 — >訂單」方格「送貨地址」欄缺少國家/地區

修正「管理訂單」格線中的「送貨地址」欄未顯示國際訂單國家/地區的問題。 地址現在包含國家資訊，以改善訂單可見度和可用性。

_AC-16256 - [GitHub問題](https://github.com/magento/magento2/issues/40403) - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/3e41a43b)_

#### 非同步訂單消費者拒絕具有遞延庫存更新的訂單：CartManagementPlugin：：getActive()中的NoThocEntityException （非使用中報價）

修正來賓訂單的非同步簽出與延遲庫存更新失敗的關鍵問題。 先前，消費者因非作用中引號而擲回NoSuchEntityException，導致訂單標示為「已拒絕」而非「擱置中」。 修正之後，消費者會正確處理非使用中報價單、將訂單從「已接收」移至「暫緩」，並依預期調整可銷售數量。 MFTF測試AsyncOrderWithAsyncStockReservationTest現在通過。

_AC-16680 - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
#### GraphQL cancelOrder不會取消使用禮品卡全額支付的訂單

在此修正前，已透過禮品卡全額付款的訂單，在透過GraphQL突變呼叫時不會自動變成「已關閉」狀態。 現在，修正後，透過GraphQL取消時，訂單會變為「已關閉」狀態。

_ACP2E-4455 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/e2b23caa)_

#### 取消/拒絕訂單時，優惠券的使用情況不會恢復

現在，當您取消訂單時，即使訂單狀態設定已修改，套用的優惠券使用量也會正確重設。 當自訂訂單狀態設定就緒時，這可能會導致訂單取消後優惠券仍被標示為已使用。
...
#### 根據註冊使用者的客戶區段延遲的購物車價格規則

修正根據客戶區段的購物車價格規則未立即套用至註冊使用者的問題。 現在，將合格產品新增到購物車時，不需要重新整理代號，即可正確套用折扣。

_LYNX-814_

#### GQL - ProductInterface中的數量欄位未傳回可銷售數量

解決ProductInterface中的數量欄位未傳回可銷售數量的GraphQL問題。

_LYNX-816_

#### 無法為不可為空的欄位「SelectedShippingMethod.carrier_code」傳回null

修正在使用美國地址結帳期間選取第二個送貨方法時，導致不可為空的欄位「SelectedShippingMethod.carrier_code」出現「無法傳回null」錯誤的問題。 此修正可確保順利導覽以簽出，而不會觸發內部伺服器錯誤。

_LYNX-817_

#### [AC-2.4.9] addProductsToCartMutation發生錯誤時傳回200

引入新的錯誤代碼REQUIRED_PARAMETER_MISSING，當在加入購物車期間未選取可設定的產品選項時處理使用者錯誤。

_LYNX-884_

#### [AC-2.4.9]停用購物車清查時，請求CartItem.not_available_message或is_available欄位時發生錯誤

修正當購物車庫存檢查停用時，存取CartItem上的not_available_message或is_available時發生錯誤。
...
#### Cron作業因OOM而卡住 — 要求檢閱cron的innodb_buffer_pool_size和PHP memory_limit

付款交易處理已改善

_ACP2E-4601 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c12a7510)_
...
#### `[CLOUD][B2B]` `[Mainline]` sales_clean_quotes getSize()瓶頸

改善sales_clean_quotes cron工作的效能。

_ACP2E-4610 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_

#### 最後層級子類別在管理類別樹狀結構中顯示零產品計數

在修正之前，分葉類別在顯示在管理員區域類別樹狀結構中時，不會合併產品計數。 修正後，每個類別分葉都會正確顯示產品計數。

_ACP2E-4689 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/d8a248cd)_

#### magento_reward_history資料表因為資料過大，導致查詢效能緩慢

修正大型magento_reward_history表格上獎勵點過期cron工作執行緩慢的問題。 以前，排程點到期所使用的查詢缺少複合資料庫索引，導致對包含數百萬筆記錄的表格進行完整表格掃描。
...
#### 依價格排序或篩選不適用於無庫存的套件組合產品

啟用「顯示無庫存產品」選項時，產品清單頁面現在會依價格正確篩選及排序無庫存的套件組合產品。

_ACP2E-4475 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628) - [GitHub程式碼貢獻](https://github.com/magento/inventory/commit/a33c60f2)_
...
#### ProductInterface中不必要的逸出字元

系統現在會在GraphQL回應中傳回名稱中未逸出的`>`。

_AC-15494 - [GitHub問題](https://github.com/magento/magento2/issues/40178) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40423)_
...
#### Target規則增量索引器不會挑選停用的產品

Target規則增量索引現在會在產品啟用或停用時回應，以確保相關/向上銷售/交叉銷售建議更新，而不需要完整重新索引。

_ACP2E-4402_

#### 客戶區段無法搭配Rest API正常運作

透過REST API下訂單時，根據訂單數的客戶區段現在會正確更新。 以前，API訂單的區段會籍不會更新，因為觀察者會依賴客戶工作階段，而API請求中不提供該工作階段。

_ACP2E-4590_

#### 無法透過REST API以「類別（僅限子項）」動作條件建立購物車價格規則

修正透過REST API擷取或更新規則時，購物車價格規則條件屬性範圍(例如「類別」（僅限父項）和「類別」（僅限子項）未公開的問題。

_ACP2E-4653 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/d8a248cd)_

#### 套件組合產品免費送貨的購物車價格規則無法如預期運作

改善免運費處理方式

_ACP2E-4720 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/c58a8ad0)_

### 傳回

#### 傳回套件組合產品時的簡單選項選取問題

以前，在實施此修正之前，對於可選擇個別出貨專案以供退貨的套件組合產品，「選取專案」功能只會首次開啟快顯區塊。 選取或關閉快顯區塊後，它不會在每次呼叫「選取專案」功能時都開啟該區塊。 不過，套用此修正後，問題已解決，功能現在可如預期運作。
...
_AC-16626 - [GitHub問題](https://github.com/magento/magento2/issues/40580) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40581)_
...
#### AC-15210似乎不完整。 USPS REST API必須在不到一個月的時間內完成。

Adobe Commerce中的USPS REST API整合不完整(AC-15210)。 主要問題包括遺漏追蹤資訊、切換API型別時遺失「允許的方法」設定、過多請求可能設定配額限制，以及缺乏針對「429」配額限制錯誤的保護。 超過配額後，無法將運費顯示給客戶。
USPS REST API整合已改善為：
- 提供出貨包裹的適當追蹤資訊。
- 在USPS WEBtools和REST API之間切換時保留允許的方法設定。
- 避免向USPS API發出不必要的請求，降低達到配額限制的風險。
- 妥善處理「429」配額限制錯誤，確保客戶仍可使用運費。

_AC-16577 - [GitHub問題](https://github.com/magento/magento2/issues/40394) - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/15a9362d)_
...
#### 某些產品的USPS Rest API送貨方法未在結帳中顯示

USPS REST API送貨方法現在可用於結帳的產品。

_ACP2E-4556 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/aa2e16d1)_
...
修正透過中繼更新而變更的目錄價格規則無法一致地反映在購物車中的問題。 此項修正後，套用排程價格規則更新時，所有購物車區段（中央區塊和摘要區塊）中的產品價格都會正確更新。

_AC-16530 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/57bad413)_
...
在此修正前，每當儲存測試更新時，系統都不會正確儲存特殊起始價格。 現在，修正後，對應的特別價格起/止日期會與測試更新開始和結束日期相關聯。

_ACP2E-4433 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/f2fd9628)_
...
套裝產品動態價格（不含報價專案的稅捐計算）的轉換可正確運作。

_ACP2E-4411 - [GitHub程式碼貢獻](https://github.com/magento/magento2/commit/aa2e16d1)_
...
#### [問題] SwiftOtter-SOP-348啟用測試執行的已編譯組態快取

在測試執行期間啟用compiled_config快取，減少CPU使用量和執行時間，藉此改善整合測試效能。

_AC-16018 - [GitHub問題](https://github.com/magento/magento2/issues/40253) - [GitHub程式碼貢獻](https://github.com/magento/magento2/pull/40239)_
...
#### [問題]從`Magento_Backend`移除禁止的`@author`標籤
