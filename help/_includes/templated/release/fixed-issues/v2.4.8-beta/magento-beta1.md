...
下列49項重點內容適用於Magento Open Source 2.4.8版本。
...
* _AC-11813_：用於phpunit 10相容性的WebApi測試架構 — 與SOAP和B2B模組的RabbitMQ連線相關的問題
   * _修正附註_： PHPUnit 9已升級為PHPUnit 10，並包含Adobe Commerce的整合和WebAPI測試架構變更。 PHPUnit 10變更向後相容。
   * _GitHub程式碼貢獻_： &lt;https://github.com/magento/magento2/ （內部，未合併）>
...
我們已修正Magento Open Source 2.4.8核心程式碼中的253個問題。 此版本中包含的已修正問題子集說明如下。
