...
---
# Magento Open Source發行說明(v2.4.8-beta2)

## v2.4.8-beta2中的重點專案

下列30項重點內容適用於Magento Open Source 2.4.8版本。

### Braintree

* _BUNDLE-3400_：移除不支援的LPM
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3401_： Google付款標籤
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3402_： Apple付款標籤
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3403_： Google付費送貨回撥
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3404_：稍後付款訊息
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3405_： JS-SDK按鈕
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3406_：最佳化Braintree擴充功能中的程式碼
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _套件–3407_：更新Braintree PHP和JS SDK
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3408_：條列專案(GooglePay)
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3409_：條列專案(Apple Pay)
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3420_：封裝追蹤
   * _GitHub程式碼貢獻_： <https://github.com/magento/ext-braintree/pull/208>
...
* _AC-12012_：將Nginx版本從1.24更新為1.26
* _AC-12028_：新增與2.4.8和2.4.7的最新Composer 2.8版本的相容性
* _AC-12029_：檢查與Varnish 7.6的相容性
* _AC-12970_： PHPUnit 10升級第2部分 — 移除淘汰專案
   * _修正附註_：已將phpunit/phpunit撰寫器相依性更新為相容版本 — &quot;phpunit/phpunit&quot;：&quot;10.x&quot;
* _AC-13076_：使用最新可用版本更新所有js程式庫和npm相依性
   * _修正附註_： composer版本支援僅限於composer 2.2.x版。 現在支援也延伸至2.4.x版。
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/commit/19844aa0>
* _AC-13077_：所有隨附的擴充功能和整合元件都與PHP 8.4相容
* _AC-13078_：所有Adobe Commerce工具都與PHP 8.4相容
* _AC-13079_：所有Adobe Commerce專案層級/相依性都與PHP 8.4相容
* _AC-13256_：將TinyMCE相依性從7版降級為6.8.5版
* _AC-13276_： PHP 8.4淘汰需要Adobe Commerce重大變更
* _AC-8828_：將MySQL的預設定序設定為utf8mb4

### 其他

* _AC-12133_： Adobe Commerce 2.4.8核心程式碼與PHP 8.4相容
* _AC-12972_： 2.4.8-beta2核心品質改善
* _AC-13038_：從composer.json中移除PHP 8.1及所有相關支援
...
* _AC-10982_： [2FA]整合Duo Web SDK以支援通用提示
   * _修正附註_：待定

### 測試架構

* _AC-9037_：可針對Adobe Commerce原始碼使用Adobe著作權

### UI框架

* _AC-12944_：從adobe commerce移除TinyMCE 5

## 已修正v2.4.8-beta2中的問題

我們已修正Magento Open Source 2.4.8核心程式碼中的159個問題。 此版本中包含的已修正問題子集說明如下。
