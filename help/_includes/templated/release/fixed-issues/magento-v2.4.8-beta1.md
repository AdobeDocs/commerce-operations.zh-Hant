...
我們已修正Magento Open Source2.4.8核心程式碼中的221個問題。 此版本中包含的已修正問題子集說明如下。
...
* _AC-9922_： Google Analytics CSP錯誤https://region1.analytics.google.com
   * _修正附註_：系統現在會在啟用Google Analytics時，正確允許連線至&#39;https://region1.analytics.google.com&#39;&#39;，避免內容安全性原則(CSP)錯誤。 之前，若從歐盟啟用Google Analytics和檢視網站，將會因為拒絕連線至「https://region1.analytics.google.com&#39;」而導致CSP主控台錯誤。
...
* _AC-9712_：具有複雜`calc`運算式的php &amp; nodejs程式庫(grunt)之間較少編譯的差異
   * _修正附註_：修正php與nodejs程式庫(grunt)之間較少編譯的差異
...
* _AC-8358_： [問題]移除禁止的`@author`標籤
   * _修正附註_：系統現在會從某些模組移除禁止的`@author`標籤，以遵守編碼標準，提高程式碼品質和一致性。 先前，此標籤在某些模組中的存在違反了既定的編碼標準。
   * _GitHub問題_： <https://github.com/magento/magento2/issues/37264>
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/pull/37014>
* _AC-8360_： [問題]移除禁止的`@author`標籤
   * _修正附註_：系統現在會從某些模組移除禁止的`@author`標籤，以遵守編碼標準，提升整體程式碼品質。 先前，此標籤在某些模組中的存在違反了既定的編碼標準。
   * _GitHub問題_： <https://github.com/magento/magento2/issues/37261>
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/pull/37011>
* _AC-8361_： [問題]移除禁止的`@author`標籤
   * _修正附註_：系統現在會從某些模組移除禁止的`@author`標籤，確保程式碼更乾淨且更標準化，以遵循程式碼標準。 先前，此標籤在某些模組中的存在違反了既定的編碼標準。
   * _GitHub問題_： <https://github.com/magento/magento2/issues/37260>
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/pull/37010>
* _AC-8400_： [問題]移除禁止的`@author`標籤
   * _修正附註_：系統現在會從某些模組移除禁止的`@author`標籤，以遵守編碼標準，提升整體程式碼品質。 先前，此標籤在某些模組中的存在違反了既定的編碼標準。
   * _GitHub問題_： <https://github.com/magento/magento2/issues/37254>
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/pull/37004>
...
* _ACP2E-3002_： [CLOUD]無法如開發檔案所示停用從管理員UI傳送電子郵件
   ...
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/commit/c8931218>
* _AC-12462_：無法使用新增註解表單變更管理員中的中繼自訂狀態
   * _修正附註_：系統現在會在從管理面板的「新增註解」表單變更時，將訂單狀態正確更新為「準備好取貨」，以確保能夠準確追蹤訂單進度。 先前，訂單狀態維持為「已傳送」，即使嘗試透過「新增註解」表單將其變更為「準備好取貨」。
   * _GitHub問題_： <https://github.com/magento/magento2/issues/38917>
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/pull/38923>
