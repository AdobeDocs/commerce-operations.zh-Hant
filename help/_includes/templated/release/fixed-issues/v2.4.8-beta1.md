...
我們已修正Adobe Commerce 2.4.8核心程式碼中的253個問題。 此版本中包含的已修正問題子集說明如下。
...
* _AC-12829_：管理員登入，但OTP功能因Chrome升級127而中斷
...
* _AC-12124_： [隨機錯誤]未載入Fotorama程式庫
...
* _AC-5969_： AlertProcessor — 引數#2數($storeId)必須是int型別，必須提供字串
   ...
   * _GitHub程式碼貢獻_： <https://github.com/magento/magento2/commit/0574ac23>
* _AC-12880_：所有隨附的擴充功能每日組建 — 未產生誘惑報告
   * _修正附註_：誘惑報告應產生且無任何錯誤
...
* _AC-12669_： Vimeo/YouTube影片播放判斷提示在頁面產生器測試中失敗
...
* _AC-11806_：無法更新SchemaBuilder.php中的Magento錯誤，行： 253
   * _GitHub問題_： <https://github.com/magento/magento2/issues/38592>
