...
遵循 [發行排程](https://devdocs.magento.com/release/)，指派預算與發行時段進行升級，避免假日、公司關閉及高峰時段。 瞭解Adobe發行排程，並透過 [發行說明](https://devdocs.magento.com/guides/v2.4/release-notes/bk-release-notes.html)，您就能更妥善地規劃年份。
