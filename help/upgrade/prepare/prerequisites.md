...
請確定您更新了環境中的所有系統需求和相依性。 檢閱目標PHP版本和[必要的PHP設定](../../installation/prerequisites/php-settings.md#php-settings)的[PHP移轉附錄](https://www.php.net/manual/en/appendices.php)。
...
* [安裝Elasticsearch](https://www.elastic.co/docs/deploy-manage/deploy/self-managed/installing-elasticsearch)
